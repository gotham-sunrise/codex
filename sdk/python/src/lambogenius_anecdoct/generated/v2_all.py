...
#   filename:  anecdoct_app_server_protocol.v2.schemas.json
...
class AnecdoctAppServerProtocolV2(BaseModel):
    pass
...
class AnecdoctErrorInfoValue(Enum):
...
class HttpConnectionFailedAnecdoctErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedAnecdoctErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedAnecdoctErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsAnecdoctErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_anecdoct_folder: Annotated[AbsolutePathBuf, Field(alias="dotAnecdoctFolder")]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.anecdoct, etc.).",
        ),
    ] = None
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    anecdoct_streamlined_login: Annotated[bool | None, Field(alias="anecdoctStreamlinedLogin")] = (
        None
    )
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Anecdoct attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class ReasoningSummary(RootModel[ReasoningSummaryValue | Literal["none"]]):
    ...
    root: Annotated[
        ...
        Field(
            description="A summary of the reasoning performed by the model. This can be useful for debugging and understanding the model's reasoning process. See https://platform.lambogenius.com/docs/guides/reasoning?api-mode=responses#reasoning-summaries"
        ),
    ]
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `anecdoct_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableAnecdoctErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class AnecdoctErrorInfo(
    RootModel[
        AnecdoctErrorInfoValue
        | HttpConnectionFailedAnecdoctErrorInfo
        | ResponseStreamConnectionFailedAnecdoctErrorInfo
        | ResponseStreamDisconnectedAnecdoctErrorInfo
        | ResponseTooManyFailedAttemptsAnecdoctErrorInfo
        | ActiveTurnNotSteerableAnecdoctErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class GetAccountResponse(BaseModel):
    ...
    requires_lambogenius_auth: Annotated[bool, Field(alias="requiresLambogeniusAuth")]
...
class TurnError(BaseModel):
    ...
    anecdoct_error_info: Annotated[AnecdoctErrorInfo | None, Field(alias="anecdoctErrorInfo")] = (
        None
    )
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `anecdoct`).",
        ),
    ] = None
...
class Thread(BaseModel):
    ...
    model_provider: Annotated[
        ...
        Field(
            alias="modelProvider",
            description="Model provider used for this thread (for example, 'lambogenius').",
        ),
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, anecdoct exec, anecdoct app-server, etc.)."
        ),
    ]
