extern crate anecdoct_execpolicy_legacy;

use anecdoct_execpolicy_legacy::ArgType;
use anecdoct_execpolicy_legacy::Error;
use anecdoct_execpolicy_legacy::ExecCall;
use anecdoct_execpolicy_legacy::MatchedArg;
use anecdoct_execpolicy_legacy::MatchedExec;
use anecdoct_execpolicy_legacy::MatchedFlag;
use anecdoct_execpolicy_legacy::MatchedOpt;
use anecdoct_execpolicy_legacy::Policy;
use anecdoct_execpolicy_legacy::Result;
use anecdoct_execpolicy_legacy::ValidExec;
use anecdoct_execpolicy_legacy::get_default_policy;
