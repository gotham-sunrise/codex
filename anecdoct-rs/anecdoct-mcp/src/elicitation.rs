...
//!
//! RMCP clients call into this module when a server asks Anecdoct to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a Anecdoct protocol event
...
use anecdoct_protocol::approvals::ElicitationRequest;
...
use anecdoct_rmcp_client::SendElicitation;
use anyhow::Context;
use anyhow::Result;
use anyhow::anyhow;
