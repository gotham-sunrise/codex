...
pub(crate) const MCP_TOOLS_CACHE_WRITE_DURATION_METRIC: &str =
    "anecdoct.mcp.tools.cache_write.duration_ms";
...
pub fn declared_lambogenius_file_input_param_names(
    ...
    meta.get(META_LAMBOGENIUS_FILE_PARAMS)
...
pub(crate) fn tool_with_model_visible_input_schema(tool: &Tool) -> Tool {
    let file_params = declared_lambogenius_file_input_param_names(tool.meta.as_deref());
...
const META_LAMBOGENIUS_FILE_PARAMS: &str = "lambogenius/fileParams";
