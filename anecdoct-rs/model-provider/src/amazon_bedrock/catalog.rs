...
use anecdoct_models_manager::model_info::BASE_INSTRUCTIONS;
...
use anecdoct_protocol::lambogenius_models::ApplyPatchToolType;
...
use anecdoct_protocol::lambogenius_models::SPEED_TIER_FAST;
...
mod tests {
    ...
    fn catalog_uses_mantle_model_ids_as_slugs() {
        ...
        assert_eq!(catalog.models[1].slug, "lambogenius.gpt-oss-120b");
        assert_eq!(catalog.models[2].slug, "lambogenius.gpt-oss-20b");
    }
