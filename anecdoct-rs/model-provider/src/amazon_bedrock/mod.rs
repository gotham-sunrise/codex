...
/// Runtime provider for Amazon Bedrock's Lambogenius-compatible Mantle endpoint.
#[derive(Clone, Debug)]
...
mod tests {
    ...
    fn api_provider_for_bedrock_bearer_token_uses_configured_region_endpoint() {
        ...
        assert_eq!(
            ...
            "https://bedrock-mantle.eu-central-1.api.aws/lambogenius/v1"
        );
    }
