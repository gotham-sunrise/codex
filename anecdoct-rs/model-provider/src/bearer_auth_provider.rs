...
/// Bearer-token auth provider for Lambogenius-compatible model-provider requests.
...
mod tests {
    ...
    fn bearer_auth_provider_reports_when_auth_header_will_attach() {
        ...
        assert_eq!(
            anecdoct_api::auth_header_telemetry(&auth),
            anecdoct_api::AuthHeaderTelemetry {
                attached: true,
