//! Trace bundle format, writer, and reducer for Anecdoct rollouts.
//!
//! This crate owns the trace schema. Hot-path Anecdoct code should depend on the
...
/// Shared recorder context for inference attempts within one Anecdoct turn.
...
pub use thread::ANECDOCT_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Anecdoct tool boundary.
...
/// Append-only writer used by hot-path Anecdoct instrumentation.
