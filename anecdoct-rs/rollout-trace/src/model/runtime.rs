...
/// Runtime operation requested by the model, a JS code cell, or Anecdoct itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_anecdoct_turn_id: Option<AnecdoctTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Anecdoct tool boundary.
    ///
    ...
    /// they describe how Anecdoct executed the request, not what the caller sent.
