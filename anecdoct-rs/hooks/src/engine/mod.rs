...
pub(crate) struct ConfiguredHandler {
    pub event_name: anecdoct_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            anecdoct_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            anecdoct_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            anecdoct_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            anecdoct_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            anecdoct_protocol::protocol::HookEventName::PostCompact => "post-compact",
            anecdoct_protocol::protocol::HookEventName::SessionStart => "session-start",
            anecdoct_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            anecdoct_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<anecdoct_protocol::items::HookPromptFragment>,
    ) -> Vec<anecdoct_protocol::items::HookPromptFragment> {
        self.output_spiller
