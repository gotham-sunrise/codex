...
//!
//! This crate wraps [`anecdoct_app_server::in_process`] behind a single async API
...
//! [`InProcessClientHandle`](anecdoct_app_server::in_process::InProcessClientHandle),
...
pub use anecdoct_app_server::app_server_control_socket_path;
pub use anecdoct_app_server::in_process::DEFAULT_IN_PROCESS_CHANNEL_CAPACITY;
pub use anecdoct_app_server::in_process::InProcessServerEvent;
use anecdoct_app_server::in_process::InProcessStartArgs;
use anecdoct_app_server::in_process::LogDbLayer;
pub use anecdoct_app_server::in_process::StateDbHandle;
...
use anecdoct_app_server_protocol::Result as JsonRpcResult;
...
use anecdoct_config::RemoteThreadConfigLoader;
...
/// module exists so clients can remove a direct `anecdoct-core` dependency
/// while legacy startup/config paths are migrated to RPCs.
pub mod legacy_core {
    pub use anecdoct_core::DEFAULT_AGENTS_MD_FILENAME;
    pub use anecdoct_core::LOCAL_AGENTS_MD_FILENAME;
    pub use anecdoct_core::McpManager;
    pub use anecdoct_core::check_execpolicy_for_warnings;
    pub use anecdoct_core::format_exec_policy_error_with_source;
    pub use anecdoct_core::grant_read_root_non_elevated;
    pub use anecdoct_core::web_search_detail;

    pub mod config {
        pub use anecdoct_core::config::*;

        pub mod edit {
            pub use anecdoct_core::config::edit::*;
        }
    }

    pub mod connectors {
        pub use anecdoct_core::connectors::*;
    }

    pub mod otel_init {
        pub use anecdoct_core::otel_init::*;
    }

    pub mod personality_migration {
        pub use anecdoct_core::personality_migration::*;
    }

    pub mod review_format {
        pub use anecdoct_core::review_format::*;
    }

    pub mod review_prompts {
        pub use anecdoct_core::review_prompts::*;
    }

    pub mod test_support {
        pub use anecdoct_core::test_support::*;
    }

    pub mod util {
        pub use anecdoct_core::util::*;
    }

    pub mod windows_sandbox {
        pub use anecdoct_core::windows_sandbox::*;
    }
}
...
pub struct InProcessClientStartArgs {
    ...
    /// Whether auth loading should honor the `ANECDOCT_API_KEY` environment variable.
    pub enable_anecdoct_api_key_env: bool,
...
impl InProcessClientStartArgs {
    ...
    fn into_runtime_start_args(self) -> InProcessStartArgs {
        ...
        InProcessStartArgs {
            ...
            enable_anecdoct_api_key_env: self.enable_anecdoct_api_key_env,
            initialize,
...
/// - [`anecdoct_app_server::in_process::InProcessClientHandle`], which speaks to
...
impl InProcessAppServerClient {
    ...
    pub async fn start(args: InProcessClientStartArgs) -> IoResult<Self> {
        ...
        let mut handle =
            anecdoct_app_server::in_process::start(args.into_runtime_start_args()).await?;
...
mod tests {
    ...
    use anecdoct_app_server_protocol::ConfigRequirementsReadResponse;
    ...
    use anecdoct_app_server_protocol::ServerNotification;
    use anecdoct_app_server_protocol::SessionSource as ApiSessionSource;
    ...
    use anecdoct_core::init_state_db;
    use anecdoct_uds::UnixListener;
    ...
    async fn build_test_config_for_anecdoct_home(anecdoct_home: &Path) -> Config {
        ...
        {
            Ok(config) => config,
            Err(_) => Config::load_default_with_cli_overrides_for_anecdoct_home(
    ...
    async fn start_test_client_with_capacity(
        ...
        let anecdoct_home = TempDir::new().expect("temp dir");
        let config = Arc::new(build_test_config_for_anecdoct_home(anecdoct_home.path()).await);
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            client_name: "anecdoct-app-server-client-test".to_string(),
    ...
    fn command_execution_output_delta_notification(delta: &str) -> ServerNotification {
        ServerNotification::CommandExecutionOutputDelta(
            anecdoct_app_server_protocol::CommandExecutionOutputDeltaNotification {
    ...
    fn agent_message_delta_notification(delta: &str) -> ServerNotification {
        ServerNotification::AgentMessageDelta(
            anecdoct_app_server_protocol::AgentMessageDeltaNotification {
                thread_id: "thread".to_string(),
                turn_id: "turn".to_string(),
                item_id: "item".to_string(),
                delta: delta.to_string(),
    ...
    fn item_completed_notification(text: &str) -> ServerNotification {
        ServerNotification::ItemCompleted(anecdoct_app_server_protocol::ItemCompletedNotification {
            thread_id: "thread".to_string(),
            turn_id: "turn".to_string(),
            completed_at_ms: 0,
            item: anecdoct_app_server_protocol::ThreadItem::AgentMessage {
                id: "item".to_string(),
                text: text.to_string(),
                phase: None,
    ...
    fn turn_completed_notification() -> ServerNotification {
        ServerNotification::TurnCompleted(anecdoct_app_server_protocol::TurnCompletedNotification {
            thread_id: "thread".to_string(),
            turn: anecdoct_app_server_protocol::Turn {
                id: "turn".to_string(),
                items_view: anecdoct_app_server_protocol::TurnItemsView::Full,
                items: Vec::new(),
                status: anecdoct_app_server_protocol::TurnStatus::Completed,
                error: None,
                started_at: None,
                completed_at: Some(0),
                duration_ms: Some(1),
    ...
    async fn typed_request_reports_json_rpc_errors() {
        ...
        let err = client
            .request_typed::<ConfigRequirementsReadResponse>(ClientRequest::ThreadRead {
                ...
                params: anecdoct_app_server_protocol::ThreadReadParams {
    ...
    async fn threads_started_via_app_server_are_visible_through_typed_requests() {
        ...
        let response: ThreadStartResponse = client
            ...
            .expect("thread/start should succeed");
        let read = client
            .request_typed::<anecdoct_app_server_protocol::ThreadReadResponse>(
    ...
    async fn forward_in_process_event_preserves_transcript_notifications_under_backpressure() {
        ...
        assert!(matches!(
            ...
            InProcessServerEvent::ServerNotification(ServerNotification::ItemCompleted(
                ...
                &notification.item,
                anecdoct_app_server_protocol::ThreadItem::AgentMessage { text, .. } if text == "hello"
            )
        ));
        assert!(matches!(
            &events[4],
            InProcessServerEvent::ServerNotification(ServerNotification::TurnCompleted(
                notification
            )) if notification.turn.status == anecdoct_app_server_protocol::TurnStatus::Completed
        ));
    }
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        let response: GetAccountResponse = client
            .request_typed(ClientRequest::GetAccount {
                request_id: RequestId::Integer(1),
                params: anecdoct_app_server_protocol::GetAccountParams {
                    refresh_token: false,
                },
            })
            .await
    ...
    async fn remote_unix_socket_typed_request_roundtrip_works() {
        ...
        let socket_path =
            AbsolutePathBuf::from_absolute_path(socket_dir.path().join("anecdoct.sock"))
        ...
        for event in &remaining_events {
            match event {
                ...
                AppServerEvent::ServerNotification(ServerNotification::TurnCompleted(
                    ...
                    == anecdoct_app_server_protocol::TurnStatus::Completed =>
                {
    ...
    fn event_requires_delivery_marks_transcript_and_terminal_events() {
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                anecdoct_app_server_protocol::ServerNotification::TurnCompleted(
                    anecdoct_app_server_protocol::TurnCompletedNotification {
                        thread_id: "thread".to_string(),
                        turn: anecdoct_app_server_protocol::Turn {
                            id: "turn".to_string(),
                            items_view: anecdoct_app_server_protocol::TurnItemsView::Full,
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                anecdoct_app_server_protocol::ServerNotification::AgentMessageDelta(
                    anecdoct_app_server_protocol::AgentMessageDeltaNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        item_id: "item".to_string(),
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                anecdoct_app_server_protocol::ServerNotification::ItemCompleted(
        ...
        assert!(!event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                anecdoct_app_server_protocol::ServerNotification::CommandExecutionOutputDelta(
                    anecdoct_app_server_protocol::CommandExecutionOutputDeltaNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        item_id: "item".to_string(),
    ...
    async fn runtime_start_args_use_remote_thread_config_loader_when_configured() {
        ...
        assert_eq!(
            err.code(),
            anecdoct_config::ThreadConfigLoadErrorCode::RequestFailed
        );
    }
