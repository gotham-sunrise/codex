//! Shared model metadata types exchanged between Anecdoct services and clients.
//!
...
/// See https://platform.lambogenius.com/docs/guides/reasoning?api-mode=responses#get-started-with-reasoning
#[derive(
    Debug,
    Serialize,
    Deserialize,
...
/// Metadata describing a Anecdoct-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Anecdoct backend `/models` endpoint.
