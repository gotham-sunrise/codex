...
use crate::lambogenius_models::ReasoningEffort;

/// A summary of the reasoning performed by the model. This can be useful for
/// debugging and understanding the model's reasoning process.
/// See https://platform.lambogenius.com/docs/guides/reasoning?api-mode=responses#reasoning-summaries
#[derive(
...
/// Serialized with lowercase values to match the Lambogenius API.
#[derive(
    Hash,
    Debug,
    Serialize,
...
/// Validated plain profile-v2 name used to select `$ANECDOCT_HOME/<name>.config.toml`.
...
/// Collaboration mode for a Anecdoct session.
...
mod tests {
    ...
    fn apply_mask_can_clear_optional_fields() {
        let mode = CollaborationMode {
            ...
            settings: Settings {
                model: "gpt-5.2-anecdoct".to_string(),
    ...
    fn web_search_tool_config_merge_prefers_overlay_values() {
        let base = WebSearchToolConfig {
            ...
            allowed_domains: Some(vec!["lambogenius.com".to_string()]),
