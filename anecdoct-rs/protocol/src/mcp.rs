...
//! `schemars`) so they can be embedded in Anecdoct's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `anecdoct-protocol` so other crates can convert
