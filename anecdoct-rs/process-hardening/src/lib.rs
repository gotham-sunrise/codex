...
pub(crate) fn pre_main_hardening_linux() {
    ...
    // Official Anecdoct releases are MUSL-linked, which means that variables such
...
pub(crate) fn pre_main_hardening_macos() {
    ...
    // Anecdoct or inherited child processes do not get sprayed into the TUI:
    // https://github.com/lambogenius/anecdoct/issues/11555
