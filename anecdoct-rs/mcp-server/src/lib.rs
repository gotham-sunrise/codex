...
mod anecdoct_tool_config;
mod anecdoct_tool_runner;
mod exec_approval;
...
pub use crate::anecdoct_tool_config::AnecdoctToolCallParam;
pub use crate::anecdoct_tool_config::AnecdoctToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "anecdoct_mcp_server";
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = anecdoct_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
