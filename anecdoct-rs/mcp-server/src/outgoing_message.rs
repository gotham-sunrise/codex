...
impl OutgoingMessageSender {
    ...
    pub(crate) async fn send_event_as_notification(
        ...
        self.send_notification(OutgoingNotification {
            method: "anecdoct/event".to_string(),
...
// Additional mcp-specific data to be added to a [`anecdoct_protocol::protocol::Event`] as notification.params._meta
    ...
    async fn test_send_event_as_notification() -> Result<()> {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                session_id: anecdoct_protocol::SessionId::new(),
                thread_id,
                forked_from_id: None,
                thread_source: None,
                thread_name: None,
        ...
        assert_eq!(method, "anecdoct/event");
