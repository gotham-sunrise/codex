use anecdoct_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use anecdoct_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use anecdoct_app_server_protocol::CollabAgentTool;
use anecdoct_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use anecdoct_app_server_protocol::CommandAction;
use anecdoct_app_server_protocol::CommandExecutionSource;
use anecdoct_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use anecdoct_app_server_protocol::ErrorNotification;
use anecdoct_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use anecdoct_app_server_protocol::ItemCompletedNotification;
use anecdoct_app_server_protocol::ItemStartedNotification;
use anecdoct_app_server_protocol::McpToolCallError;
use anecdoct_app_server_protocol::McpToolCallResult;
use anecdoct_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use anecdoct_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use anecdoct_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use anecdoct_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use anecdoct_exec::AgentMessageItem;
use anecdoct_exec::AnecdoctStatus;
use anecdoct_exec::CollabAgentState;
use anecdoct_exec::CollabAgentStatus;
use anecdoct_exec::CollabTool;
use anecdoct_exec::CollabToolCallItem;
use anecdoct_exec::CollabToolCallStatus;
use anecdoct_exec::CollectedThreadEvents;
use anecdoct_exec::CommandExecutionItem;
use anecdoct_exec::CommandExecutionStatus;
use anecdoct_exec::ErrorItem;
use anecdoct_exec::EventProcessorWithJsonOutput;
use anecdoct_exec::ExecThreadItem;
use anecdoct_exec::FileChangeItem;
use anecdoct_exec::FileUpdateChange as ExecFileUpdateChange;
use anecdoct_exec::ItemCompletedEvent;
use anecdoct_exec::ItemStartedEvent;
use anecdoct_exec::ItemUpdatedEvent;
use anecdoct_exec::McpToolCallItem;
use anecdoct_exec::McpToolCallItemError;
use anecdoct_exec::McpToolCallItemResult;
use anecdoct_exec::McpToolCallStatus;
use anecdoct_exec::PatchApplyStatus;
use anecdoct_exec::PatchChangeKind;
use anecdoct_exec::ReasoningItem;
use anecdoct_exec::ThreadErrorEvent;
use anecdoct_exec::ThreadEvent;
use anecdoct_exec::ThreadItemDetails;
use anecdoct_exec::ThreadStartedEvent;
use anecdoct_exec::TodoItem;
use anecdoct_exec::TodoListItem;
use anecdoct_exec::TurnCompletedEvent;
use anecdoct_exec::TurnFailedEvent;
use anecdoct_exec::TurnStartedEvent;
use anecdoct_exec::Usage;
use anecdoct_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        thread_source: None,
        thread_name: None,
        model: "anecdoct-mini-latest".to_string(),
        model_provider_id: "test-provider".to_string(),
        service_tier: None,
        approval_policy: AskForApproval::Never,
        approvals_reviewer: anecdoct_protocol::config_types::ApprovalsReviewer::User,
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: AnecdoctStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            anecdoct_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, AnecdoctStatus::Running);
    ...
    assert_eq!(collected.status, AnecdoctStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        anecdoct_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: anecdoct_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
