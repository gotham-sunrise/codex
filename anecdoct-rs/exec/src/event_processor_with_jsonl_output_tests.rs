...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        anecdoct_app_server_protocol::TurnCompletedNotification {
            ...
            turn: anecdoct_app_server_protocol::Turn {
                ...
                error: Some(anecdoct_app_server_protocol::TurnError {
    ...
    assert_eq!(status, AnecdoctStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        anecdoct_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "Lambogenius Anecdoct CLI documentation"}]}),
                mcp_app_resource_uri: None,
                result: Some(Box::new(anecdoct_app_server_protocol::McpToolCallResult {
