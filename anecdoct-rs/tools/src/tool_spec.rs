...
use anecdoct_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use anecdoct_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
use anecdoct_protocol::config_types::WebSearchUserLocationType;
use serde::Serialize;
use serde_json::Value;

/// When serialized as JSON, this produces a valid "Tool" in the Lambogenius
/// Responses API.
...
pub enum ToolSpec {
    ...
    // say it's supported.
    // https://platform.lambogenius.com/docs/guides/tools-web-search?api-mode=responses#:~:text=%7B%20type%3A%20%22web_search%22%20%7D%2C
    // The `external_web_access` field determines whether the web search is over
    // cached or live content.
    // https://platform.lambogenius.com/docs/guides/tools-web-search#live-internet-access
...
/// Responses API:
/// https://platform.lambogenius.com/docs/guides/function-calling?api-mode=responses
