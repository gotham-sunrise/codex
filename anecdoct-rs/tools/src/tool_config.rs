...
use anecdoct_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
...
impl ToolsConfig {
    pub fn new(params: &ToolsConfigParams<'_>) -> Self {
        ...
        // API-key auth bypasses Anecdoct backend entitlement/tool normalization, so
        ...
        let shell_type = if !features.enabled(Feature::ShellTool) {
            ...
            if anecdoct_utils_pty::conpty_supported() {
