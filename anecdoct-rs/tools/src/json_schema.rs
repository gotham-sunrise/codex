...
///
/// This mirrors the Lambogenius Structured Outputs subset for JSON Schema `type`:
/// string, number, boolean, integer, object, array, and null.
/// Keywords such as `enum`, `const`, and `anyOf` are modeled separately.
/// See <https://developers.lambogenius.com/api/docs/guides/structured-outputs#supported-schemas>.
