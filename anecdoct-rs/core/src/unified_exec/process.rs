...
use anecdoct_exec_server::ReadResponse as ExecReadResponse;
use anecdoct_exec_server::StartedExecProcess;
use anecdoct_exec_server::WriteStatus;
use anecdoct_protocol::exec_output::ExecToolCallOutput;
use anecdoct_protocol::exec_output::StreamOutput;
use anecdoct_protocol::protocol::TruncationPolicy;
...
use anecdoct_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = anecdoct_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
