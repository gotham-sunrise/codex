...
use anecdoct_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth(auth: AnecdoctAuth) -> Arc<AuthManager> {
...
pub fn auth_manager_from_auth_with_home(
    ...
    AuthManager::from_auth_for_testing_with_home(auth, anecdoct_home)
}
...
) -> anecdoct_protocol::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(anecdoct_home, /*config_model_catalog*/ None)
}
