...
impl ResolvedTurnEnvironments {
    ...
    pub(crate) fn primary_environment(&self) -> Option<Arc<anecdoct_exec_server::Environment>> {
        self.primary()
...
pub(crate) fn resolve_environment_selections(
    ...
    for selected_environment in environments {
        ...
        let environment = environment_manager
            ...
            .ok_or_else(|| {
                AnecdoctErr::InvalidRequest(format!(
...
"#,
        ...
        let cwd = AbsolutePathBuf::current_dir().expect("cwd");
        let manager = EnvironmentManager::from_anecdoct_home(temp_dir.path(), test_runtime_paths())
            .await
