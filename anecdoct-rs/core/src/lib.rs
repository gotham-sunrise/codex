//! Root of the `anecdoct-core` library.
...
mod config_lock;
pub use anecdoct_thread::AnecdoctThread;
pub use anecdoct_thread::AnecdoctThreadTurnContextOverrides;
pub use anecdoct_thread::ThreadConfigSnapshot;
...
pub use anecdoct_mcp::SandboxState;
mod mcp_lambogenius_file;
mod mcp_tool_call;
...
pub use anecdoct_protocol::config_types::ModelProviderAuthInfo;
...
#[deprecated(note = "use AnecdoctThread")]
pub type AnecdoctConversation = AnecdoctThread;
...
pub use client::X_ANECDOCT_INSTALLATION_ID_HEADER;
pub use client::X_ANECDOCT_TURN_METADATA_HEADER;
