...
use anecdoct_utils_cache::BlockingLruCache;
use anecdoct_utils_cache::sha1_digest;
use anecdoct_utils_output_truncation::TruncationPolicy;
use anecdoct_utils_output_truncation::approx_bytes_for_tokens;
use anecdoct_utils_output_truncation::approx_token_count;
use anecdoct_utils_output_truncation::approx_tokens_from_byte_count_i64;
use anecdoct_utils_output_truncation::truncate_function_output_items_with_policy;
...
// See https://platform.lambogenius.com/docs/guides/images-vision#calculating-costs.
...
// See https://platform.lambogenius.com/docs/guides/images-vision#model-sizing-behavior.
...
pub(crate) fn is_anecdoct_generated_item(item: &ResponseItem) -> bool {
    matches!(
        item,
        ResponseItem::FunctionCallOutput { .. }
            | ResponseItem::ToolSearchOutput { .. }
