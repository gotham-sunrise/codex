use super::*;
use anecdoct_mcp::ElicitationReviewRequest;
use anecdoct_mcp::ElicitationReviewer;
use anecdoct_mcp::ElicitationReviewerHandle;
use anecdoct_protocol::config_types::ApprovalsReviewer;
use anecdoct_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as MCP_ELICITATION_APPROVAL_KIND_KEY;
use anecdoct_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as MCP_ELICITATION_APPROVAL_KIND_MCP_TOOL_CALL;
use anecdoct_protocol::mcp_approval_meta::APPROVALS_REVIEWER_KEY as MCP_ELICITATION_APPROVALS_REVIEWER_KEY;
use anecdoct_protocol::mcp_approval_meta::CONNECTOR_DESCRIPTION_KEY as MCP_ELICITATION_CONNECTOR_DESCRIPTION_KEY;
use anecdoct_protocol::mcp_approval_meta::CONNECTOR_ID_KEY as MCP_ELICITATION_CONNECTOR_ID_KEY;
use anecdoct_protocol::mcp_approval_meta::CONNECTOR_NAME_KEY as MCP_ELICITATION_CONNECTOR_NAME_KEY;
use anecdoct_protocol::mcp_approval_meta::REQUEST_TYPE_APPROVAL_REQUEST as MCP_ELICITATION_REQUEST_TYPE_APPROVAL_REQUEST;
use anecdoct_protocol::mcp_approval_meta::REQUEST_TYPE_KEY as MCP_ELICITATION_REQUEST_TYPE_KEY;
use anecdoct_protocol::mcp_approval_meta::TOOL_DESCRIPTION_KEY as MCP_ELICITATION_TOOL_DESCRIPTION_KEY;
use anecdoct_protocol::mcp_approval_meta::TOOL_NAME_KEY as MCP_ELICITATION_TOOL_NAME_KEY;
use anecdoct_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as MCP_ELICITATION_TOOL_PARAMS_KEY;
use anecdoct_protocol::mcp_approval_meta::TOOL_TITLE_KEY as MCP_ELICITATION_TOOL_TITLE_KEY;
    ...
    pub async fn request_mcp_server_elicitation(
            ...
            .elicitations_auto_deny()
        {
            return Some(ElicitationResponse {
                action: anecdoct_rmcp_client::ElicitationAction::Accept,
        ...
        let request = match params.request {
            McpServerElicitationRequest::Form {
                ...
                anecdoct_protocol::approvals::ElicitationRequest::Form {
                    meta,
                    message,
                    requested_schema,
                }
        ...
        let id = match request_id {
            rmcp::model::NumberOrString::String(value) => {
                anecdoct_protocol::mcp::RequestId::String(value.to_string())
            }
            rmcp::model::NumberOrString::Number(value) => {
                anecdoct_protocol::mcp::RequestId::Integer(value)
            }
        };
