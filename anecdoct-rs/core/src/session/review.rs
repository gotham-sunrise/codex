...
pub(super) async fn spawn_review_thread(
    ...
    let review_turn_context = TurnContext {
        ...
        anecdoct_self_exe: parent_turn_context.anecdoct_self_exe.clone(),
        anecdoct_linux_sandbox_exe: parent_turn_context.anecdoct_linux_sandbox_exe.clone(),
        dynamic_tools: parent_turn_context.dynamic_tools.clone(),
        truncation_policy: model_info.truncation_policy.into(),
        turn_metadata_state,
        extension_data: Arc::new(anecdoct_extension_api::ExtensionData::new(review_turn_id)),
