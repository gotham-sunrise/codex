...
command transformation live in the anecdoct-sandboxing crate; this module keeps
...
pub use anecdoct_protocol::models::SandboxPermissions;
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: anecdoct_exec_server::ExecEnvPolicy,
...
) -> anecdoct_protocol::error::Result<ExecToolCallOutput> {
