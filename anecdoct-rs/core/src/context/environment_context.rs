...
impl ContextualUserFragment for EnvironmentContext {
    ...
    const START_MARKER: &'static str = anecdoct_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
    const END_MARKER: &'static str = anecdoct_protocol::protocol::ENVIRONMENT_CONTEXT_CLOSE_TAG;
