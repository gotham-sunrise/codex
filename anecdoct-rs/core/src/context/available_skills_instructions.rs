use anecdoct_core_skills::AvailableSkills;
use anecdoct_core_skills::render_available_skills_body;
use anecdoct_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
