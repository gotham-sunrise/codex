...
use crate::anecdoct_delegate::run_anecdoct_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        session.session.services.session_telemetry.counter(
            "anecdoct.task.review",
            /*inc*/ 1,
            &[],
        );

        // Start sub-anecdoct conversation and get the receiver for events.
