...
pub(crate) struct ConfigLockReplayOptions {
    pub allow_anecdoct_version_mismatch: bool,
}
...
pub(crate) fn validate_config_lock_replay(
    ...
    if !options.allow_anecdoct_version_mismatch
        && expected_lock.anecdoct_version != actual_lock.anecdoct_version
    {
        return Err(config_lock_error(format!(
            "config lock Anecdoct version mismatch: lock was generated by {}, current version is {}; set debug.config_lockfile.allow_anecdoct_version_mismatch=true to ignore this",
            expected_lock.anecdoct_version, actual_lock.anecdoct_version
        )));
    }
...
fn config_lock_for_comparison(
    ...
    if options.allow_anecdoct_version_mismatch {
        lockfile.anecdoct_version.clear();
    }
    lockfile
}
