...
impl ToolCallRuntime {
    ...
    pub(crate) fn handle_tool_call(
    ...
    ) -> impl std::future::Future<Output = Result<ResponseInputItem, AnecdoctErr>> {
        ...
        async move {
            match future.await {
                ...
                Err(FunctionCallError::Fatal(message)) => Err(AnecdoctErr::Fatal(message)),
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                ...
                output: anecdoct_protocol::models::FunctionCallOutputPayload {
                    body: anecdoct_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
