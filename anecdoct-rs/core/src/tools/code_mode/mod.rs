...
use anecdoct_code_mode::CodeModeNestedToolCall;
use anecdoct_code_mode::CodeModeToolKind;
use anecdoct_code_mode::CodeModeTurnHost;
use anecdoct_code_mode::RuntimeResponse;
...
use anecdoct_utils_output_truncation::formatted_truncate_text_content_items_with_policy;
...
pub(crate) const PUBLIC_TOOL_NAME: &str = anecdoct_code_mode::PUBLIC_TOOL_NAME;
pub(crate) const WAIT_TOOL_NAME: &str = anecdoct_code_mode::WAIT_TOOL_NAME;
pub(crate) const DEFAULT_WAIT_YIELD_TIME_MS: u64 = anecdoct_code_mode::DEFAULT_WAIT_YIELD_TIME_MS;
...
pub(crate) struct CodeModeService {
    inner: anecdoct_code_mode::CodeModeService,
}

impl CodeModeService {
    pub(crate) fn new() -> Self {
        Self {
            inner: anecdoct_code_mode::CodeModeService::new(),
        }
    }
    ...
    pub(crate) async fn execute(
        &self,
        request: anecdoct_code_mode::ExecuteRequest,
    ...
    pub(crate) async fn wait(
        &self,
        request: anecdoct_code_mode::WaitRequest,
    ) -> Result<anecdoct_code_mode::WaitOutcome, String> {
    ...
    ) -> Option<anecdoct_code_mode::CodeModeTurnWorker> {
