...
impl CodeModeExecuteHandler {
    ...
    async fn execute(
        ...
        let args = anecdoct_code_mode::parse_exec_source(&code)
            .map_err(FunctionCallError::RespondToModel)?;
        let exec = ExecContext { session, turn };
        let enabled_tools =
            anecdoct_tools::collect_code_mode_tool_definitions(&self.nested_tool_specs);
        ...
        let response = exec
            ...
            .services
            .code_mode_service
            .execute(anecdoct_code_mode::ExecuteRequest {
