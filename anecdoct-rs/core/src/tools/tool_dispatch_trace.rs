...
//!
//! `anecdoct-rollout-trace` owns the event schema and writer behavior. This module
...
use anecdoct_rollout_trace::ToolDispatchResult;
use anecdoct_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        anecdoct_turn_id: invocation.turn.sub_id.clone(),
