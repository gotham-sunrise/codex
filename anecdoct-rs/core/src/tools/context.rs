...
use anecdoct_protocol::models::function_call_output_content_items_to_text;
...
use anecdoct_utils_string::take_bytes_at_char_boundary;
use serde::Serialize;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the Anecdoct tool call id
