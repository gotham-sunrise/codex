...
use anecdoct_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let attempt_with_network_approval = SandboxAttempt {
            ...
            anecdoct_linux_sandbox_exe: attempt.anecdoct_linux_sandbox_exe,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            sandbox_cwd,
            anecdoct_linux_sandbox_exe: turn_ctx.anecdoct_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
    ...
    async fn request_approval<Rq, Out, T>(
        ...
        otel: &anecdoct_otel::SessionTelemetry,
