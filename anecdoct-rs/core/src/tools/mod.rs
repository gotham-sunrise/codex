...
use anecdoct_utils_output_truncation::formatted_truncate_text;
...
) -> anecdoct_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => anecdoct_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => anecdoct_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => anecdoct_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => anecdoct_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => anecdoct_tools::ToolUserShellType::Cmd,
    }
}
