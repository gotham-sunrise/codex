...
use anecdoct_tools::LoadableToolSpec;
use anecdoct_tools::TOOL_SEARCH_DEFAULT_LIMIT;
...
use anecdoct_tools::coalesce_loadable_tool_specs;
use bm25::Document;
use bm25::Language;
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        ...
        assert_eq!(
            ...
            vec![
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    ...
                    tools: vec![
                        ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                            ...
                            parameters: anecdoct_tools::JsonSchema::object(
                                Default::default(),
                                /*required*/ None,
                                Some(false.into()),
                            ),
                ...
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    name: "anecdoct_app".to_string(),
                    description: "Tools in the anecdoct_app namespace.".to_string(),
                    tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                        ...
                        parameters: anecdoct_tools::JsonSchema::object(
                            std::collections::BTreeMap::from([(
                                "mode".to_string(),
                                anecdoct_tools::JsonSchema::string(/*description*/ None),
                            )]),
