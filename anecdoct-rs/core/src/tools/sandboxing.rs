...
use anecdoct_protocol::approvals::NetworkApprovalContext;
...
use anecdoct_sandboxing::SandboxTransformError;
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and anecdoct prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a anecdoct_protocol::models::PermissionProfile,
    pub enforce_managed_network: bool,
    pub(crate) manager: &'a SandboxManager,
    pub(crate) sandbox_cwd: &'a AbsolutePathBuf,
    pub anecdoct_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
        ...
        self.manager
            ...
            .map(|request| {
                let windows_sandbox_policy_cwd =
                    anecdoct_utils_absolute_path::AbsolutePathBuf::try_from(
