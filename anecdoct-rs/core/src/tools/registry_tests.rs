...
fn handler_looks_up_namespaced_aliases_explicitly() {
    let namespace = "mcp__anecdoct_apps__gmail";
    let tool_name = "gmail_get_recent_emails";
    let plain_name = anecdoct_tools::ToolName::plain(tool_name);
    let namespaced_name = anecdoct_tools::ToolName::namespaced(namespace, tool_name);
    ...
    let missing_namespaced = registry.tool(&anecdoct_tools::ToolName::namespaced(
