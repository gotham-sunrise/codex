...
use anecdoct_models_manager::client_version_to_whole;
...
const REMOTE_MODEL: &str = "anecdoct-test-ttl";
const VERSIONED_MODEL: &str = "anecdoct-test-versioned";
const MISSING_VERSION_MODEL: &str = "anecdoct-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "anecdoct-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let anecdoct = Arc::clone(&test.anecdoct);
    ...
    let cache_path = config.anecdoct_home.join(CACHE_FILE);
    ...
    anecdoct
        .submit(Op::UserTurn {
            ...
            approval_policy: anecdoct_protocol::protocol::AskForApproval::Never,
    ...
    let _ = wait_for_event(&anecdoct, |event| {
