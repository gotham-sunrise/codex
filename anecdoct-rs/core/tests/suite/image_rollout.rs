...
async fn copy_paste_local_image_persists_rollout_request_shape() -> anyhow::Result<()> {
    ...
    let rollout_path = anecdoct.rollout_path().expect("rollout path");
    ...
    let expected = ResponseItem::Message {
        ...
        content: vec![
            ContentItem::InputText {
                text: anecdoct_protocol::models::local_image_open_tag_text(/*label_number*/ 1),
            },
...
async fn drag_drop_image_persists_rollout_request_shape() -> anyhow::Result<()> {
    ...
    let expected = ResponseItem::Message {
        ...
        content: vec![
            ContentItem::InputText {
                text: anecdoct_protocol::models::image_open_tag_text(),
            },
            ContentItem::InputImage {
                image_url,
                detail: Some(DEFAULT_IMAGE_DETAIL),
