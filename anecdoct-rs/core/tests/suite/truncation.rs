    ...
    let mut builder = test_anecdoct().with_config(move |config| {
        ...
        servers.insert(
            ...
            anecdoct_config::types::McpServerConfig {
                transport: anecdoct_config::types::McpServerTransportConfig::Stdio {
...
async fn mcp_image_output_preserves_image_and_no_text_summary() -> Result<()> {
    ...
    // 1x1 PNG data URL
    let lambogenius_png = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMB/ee9bQAAAABJRU5ErkJggg==";
    ...
    assert_eq!(
        arr[1],
        json!({"type": "input_image", "image_url": lambogenius_png, "detail": "high"})
    );
