use crate::test_anecdoct::TestAnecdoctBuilder;
use crate::test_anecdoct::test_anecdoct;
...
const ANECDOCT_APPS_META_KEY: &str = "_anecdoct_apps";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "anecdoct-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__anecdoct_apps__calendar_create_event";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__anecdoct_apps__calendar_list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__anecdoct_apps__calendar_extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__anecdoct_apps__calendar";
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestAnecdoctBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestAnecdoctBuilder {
    let apps_base_url = apps_base_url.into();
    test_anecdoct()
        .with_auth(AnecdoctAuth::create_dummy_chatgpt_auth_for_testing())
...
async fn recorded_apps_tool_calls(server: &MockServer) -> Vec<Value> {
    server
        ...
        .filter_map(|request| {
            ...
            (request.url.path() == "/api/anecdoct/apps"
...
async fn mount_streamable_http_json_rpc(
    ...
    Mock::given(method("POST"))
        .and(path_regex("^/api/anecdoct/apps/?$"))
        .respond_with(AnecdoctAppsJsonRpcResponder {
            connector_name,
...
struct AnecdoctAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
}

impl Respond for AnecdoctAppsJsonRpcResponder {
        ...
        match method {
                        ...
                        "tools": [
                            {
                                ...
                                "_meta": {
                                    ...
                                    "lambogenius/outputTemplate": CALENDAR_CREATE_EVENT_MCP_APP_RESOURCE_URI,
                                    "_anecdoct_apps": {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let anecdoct_apps_meta = body.pointer("/params/_meta/_anecdoct_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_anecdoct_apps": anecdoct_apps_meta,
                        },
                        "isError": false
                    }
                }))
