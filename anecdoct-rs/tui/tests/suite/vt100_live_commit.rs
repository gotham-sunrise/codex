...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match anecdoct_tui::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = anecdoct_tui::RowBuilder::new(/*target_width*/ 20);
    ...
    anecdoct_tui::insert_history_lines(&mut term, lines)
