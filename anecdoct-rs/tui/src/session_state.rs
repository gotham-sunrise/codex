...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: anecdoct_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<anecdoct_protocol::lambogenius_models::ReasoningEffort>,
