...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Anecdoct app name",
            ...
            TerminalTitleItem::AnecdoctVersion => "Anecdoct application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::AnecdoctVersion => Some(StatusSurfacePreviewItem::AnecdoctVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::ModelWithReasoning,
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::AnecdoctVersion,
