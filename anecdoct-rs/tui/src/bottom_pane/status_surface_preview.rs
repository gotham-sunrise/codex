...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "anecdoct",
            ...
            StatusSurfacePreviewItem::AnecdoctVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-anecdoct",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-anecdoct medium",
