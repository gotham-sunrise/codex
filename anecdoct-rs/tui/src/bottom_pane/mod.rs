...
mod tests {
    ...
    fn test_pane_with_disable_paste_burst(
        ...
        BottomPane::new(BottomPaneParams {
            ...
            placeholder_text: "Ask Anecdoct to do anything".to_string(),
            disable_paste_burst,
    ...
    fn exec_request() -> ApprovalRequest {
        ApprovalRequest::Exec {
            thread_id: anecdoct_protocol::ThreadId::new(),
            thread_label: None,
            id: "1".to_string(),
    ...
    fn esc_with_skill_popup_does_not_interrupt_task() {
        ...
        while let Ok(ev) = rx.try_recv() {
            assert!(
                !matches!(ev, AppEvent::AnecdoctOp(Op::Interrupt)),
    ...
    fn esc_interrupts_running_task_when_no_popup() {
        ...
        assert!(
            matches!(rx.try_recv(), Ok(AppEvent::AnecdoctOp(Op::Interrupt))),
