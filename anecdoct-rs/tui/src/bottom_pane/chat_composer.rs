...
//!
//! For the detailed burst state machine, see `anecdoct-rs/tui/src/bottom_pane/paste_burst.rs`.
...
#[cfg(test)]
use anecdoct_core_skills::model::SkillInterface;
    ...
    fn mention_items(&self) -> Vec<MentionItem> {
            ...
            && let Some(snapshot) = self.connectors_snapshot.as_ref()
        {
            for connector in &snapshot.connectors {
                ...
                let display_name =
                    anecdoct_connectors::metadata::connector_display_label(connector);
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            "Ask Anecdoct to do anything".to_string(),
        ...
        snapshot_composer_state(
            ...
            |composer| {
                ...
                composer.set_status_line(Some(Line::from(
                    "gpt-5.4 high fast · ~/code/anecdoct-1 · Context 0% used",
                )));
    ...
    fn status_line_hyperlink_marks_pr_number_cells() {
        ...
        let url = "https://github.com/lambogenius/anecdoct/pull/20252";
        composer.set_status_line_enabled(/*enabled*/ true);
    ...
    fn set_skill_mentions_refreshes_open_mention_popup() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            name: "anecdoct".to_string(),
            description: "Primary personal Anecdoct repo skill.".to_string(),
        ...
        assert_eq!(mention.insert_text, "$anecdoct".to_string());
...
程序员 与 Unicode 同行";
    ...
    fn file_completion_preserves_large_paste_placeholder_elements() {
        ...
        composer.on_file_search_result(
            ...
            vec![FileMatch {
                ...
                match_type: anecdoct_file_search::MatchType::File,
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("anecdoct_tui_test_paste_image.png");
