...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: anecdoct_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, anecdoct_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                anecdoct_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                anecdoct_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                anecdoct_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                anecdoct_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                anecdoct_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                anecdoct_app_server_protocol::GuardianRiskLevel::Low => {
                    anecdoct_protocol::approvals::GuardianRiskLevel::Low
                }
                anecdoct_app_server_protocol::GuardianRiskLevel::Medium => {
                    anecdoct_protocol::approvals::GuardianRiskLevel::Medium
                }
                anecdoct_app_server_protocol::GuardianRiskLevel::High => {
                    anecdoct_protocol::approvals::GuardianRiskLevel::High
                }
                anecdoct_app_server_protocol::GuardianRiskLevel::Critical => {
                    anecdoct_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    anecdoct_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        anecdoct_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    anecdoct_app_server_protocol::GuardianUserAuthorization::Low => {
                        anecdoct_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    anecdoct_app_server_protocol::GuardianUserAuthorization::Medium => {
                        anecdoct_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    anecdoct_app_server_protocol::GuardianUserAuthorization::High => {
                        anecdoct_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                anecdoct_app_server_protocol::AutoReviewDecisionSource::Agent => {
