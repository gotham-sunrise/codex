...
async fn invalid_url_elicitation_is_declined() {
    ...
    chat.handle_elicitation_request_now(
        anecdoct_app_server_protocol::RequestId::Integer(9),
        anecdoct_app_server_protocol::McpServerElicitationRequestParams {
            thread_id: thread_id.to_string(),
            turn_id: Some("turn-auth".to_string()),
            server_name: "payments".to_string(),
            request: anecdoct_app_server_protocol::McpServerElicitationRequest::Url {
                meta: None,
    ...
    assert_matches!(
        ...
        Ok(AppEvent::SubmitThreadOp {
            ...
            op: Op::ResolveElicitation {
                server_name,
                request_id: anecdoct_app_server_protocol::RequestId::Integer(9),
    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                anecdoct_error_info: Some(AnecdoctErrorInfo::ServerOverloaded),
                additional_details: None,
            },
            will_retry: false,
            thread_id: "thread-1".to_string(),
...
async fn live_app_server_thread_name_update_shows_resume_hint() {
    ...
    assert!(rendered.contains("anecdoct resume review-fix"));
}
