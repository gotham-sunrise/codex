...
impl ChatWidget {
    ...
    fn prefetch_connectors_with_options(&mut self, force_refetch: bool) {
        ...
        tokio::spawn(async move {
            ...
            let should_schedule_force_refetch =
                !force_refetch && !accessible_result.anecdoct_apps_ready;
    ...
    fn connectors_popup_params(
        ...
        for connector in connectors {
            let connector_label = anecdoct_connectors::metadata::connector_display_label(connector);
            ...
            let instructions = if connector.is_accessible {
                ...
                "Install this app in your browser, then reload Anecdoct."
            };
