...
impl ChatWidget {
    ...
    /// Clears the terminal title Anecdoct most recently wrote, if any.
    ///
    ...
    pub(super) fn status_line_value_for_item(&mut self, item: StatusLineItem) -> Option<String> {
        match item {
            ...
            StatusLineItem::AnecdoctVersion => Some(ANECDOCT_CLI_VERSION.to_string()),
    ...
    pub(super) fn status_surface_preview_value_for_item(
        ...
        let status_line_item = match item {
            StatusSurfacePreviewItem::AppName => return Some("anecdoct".to_string()),
            ...
            StatusSurfacePreviewItem::AnecdoctVersion => StatusLineItem::AnecdoctVersion,
    ...
    pub(super) fn terminal_title_value_for_item(
        ...
        match item {
            TerminalTitleItem::AppName => Some("anecdoct".to_string()),
            ...
            TerminalTitleItem::WeeklyLimit => self
                ...
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
            TerminalTitleItem::AnecdoctVersion => self
                .status_line_value_for_item(StatusLineItem::AnecdoctVersion)
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
