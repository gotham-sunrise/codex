...
use anecdoct_app_server_protocol::HookOutputEntry;
use anecdoct_app_server_protocol::HookOutputEntryKind;
use anecdoct_app_server_protocol::HookRunStatus;
use anecdoct_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
