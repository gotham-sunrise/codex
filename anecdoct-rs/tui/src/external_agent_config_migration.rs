...
mod tests {
    ...
    fn sample_plugin_details() -> anecdoct_app_server_protocol::MigrationDetails {
        anecdoct_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.anecdoct/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
