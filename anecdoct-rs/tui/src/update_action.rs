...
pub enum UpdateAction {
    ...
    BunGlobalLatest,
    /// Update via `brew upgrade anecdoct`.
    BrewUpgrade,
    /// Update via `curl -fsSL https://chatgpt.com/anecdoct/install.sh | sh`.
    StandaloneUnix,
    /// Update via `irm https://chatgpt.com/anecdoct/install.ps1|iex`.
    StandaloneWindows,
}
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            ...
            UpdateAction::BrewUpgrade => ("brew", &["upgrade", "--cask", "anecdoct"]),
            ...
            UpdateAction::StandaloneWindows => (
                "powershell",
                &["-c", "irm https://chatgpt.com/anecdoct/install.ps1|iex"],
            ),
        }
    }
    ...
    fn maps_install_context_to_update_action() {
        ...
        assert_eq!(
            UpdateAction::from_install_context(&InstallContext::Standalone {
                ...
                resources_dir: Some(native_release_dir.join("anecdoct-resources")),
            }),
