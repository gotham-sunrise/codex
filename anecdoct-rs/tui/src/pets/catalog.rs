//! Built-in pet catalog ported from the Anecdoct App avatar catalog.
...
pub(super) const BUILTIN_PETS: &[BuiltinPet] = &[
    BuiltinPet {
        id: "anecdoct",
        display_name: "Anecdoct",
        description: "The original Anecdoct companion",
        spritesheet_file: "anecdoct-spritesheet-v4.webp",
    },
    BuiltinPet {
        id: "dewey",
        display_name: "Dewey",
