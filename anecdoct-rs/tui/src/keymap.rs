...
use anecdoct_config::types::KeybindingsSpec;
...
Set unique keys in `~/.anecdoct/config.toml` and retry. \
...
Set a different key in `~/.anecdoct/config.toml` and retry. \
See the Anecdoct keymap documentation for supported actions and examples."
                ));
            }
        }
...
mod tests {
    use super::*;
    use anecdoct_config::types::KeybindingSpec;
