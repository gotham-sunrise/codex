...
use anecdoct_realtime_webrtc::RealtimeWebrtcEvent;
use anecdoct_realtime_webrtc::RealtimeWebrtcSessionHandle;
...
pub(crate) enum AppEvent {
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<anecdoct_app_server_protocol::HooksListResponse, String>,
    },
