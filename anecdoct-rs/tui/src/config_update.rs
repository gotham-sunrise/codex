...
pub(crate) fn build_service_tier_selection_edits(
    ...
    let service_tier_edit = service_tier.map_or_else(
        ...
        |service_tier| {
            let config_value =
                match anecdoct_protocol::config_types::ServiceTier::from_request_value(service_tier)
                {
                    Some(anecdoct_protocol::config_types::ServiceTier::Fast) => "fast",
                    Some(anecdoct_protocol::config_types::ServiceTier::Flex) => "flex",
                    None => service_tier,
                };
            replace_config_value(
