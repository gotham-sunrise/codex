...
//! "leave the old title alone" or "clear the title Anecdoct last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Anecdoct manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Anecdoct started managing the title.
