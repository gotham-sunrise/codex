...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Anecdoct is rebuilding normal terminal scrollback, not an
...
use anecdoct_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
