...
use anecdoct_app_server_protocol::GrantedPermissionProfile;
    ...
    fn converts_request_permissions_into_granted_permissions() {
        assert_eq!(
            granted_permission_profile_from_request(CoreRequestPermissionProfile::from(
                anecdoct_app_server_protocol::RequestPermissionProfile {
            ...
            anecdoct_app_server_protocol::GrantedPermissionProfile {
                network: Some(anecdoct_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: Some(
                ...
                anecdoct_app_server_protocol::RequestPermissionProfile {
                    ...
                    file_system: Some(
                        anecdoct_app_server_protocol::AdditionalFileSystemPermissions {
                            ...
                            glob_scan_max_depth: None,
                            entries: Some(
                                vec![anecdoct_app_server_protocol::FileSystemSandboxEntry {
                            path: anecdoct_app_server_protocol::FileSystemPath::Special {
                                value: anecdoct_app_server_protocol::FileSystemSpecialPath::Root,
                            },
                            access: anecdoct_app_server_protocol::FileSystemAccessMode::Write,
                        }]
                            ),
            ...
            anecdoct_app_server_protocol::GrantedPermissionProfile {
                ...
                file_system: Some(
                    anecdoct_app_server_protocol::AdditionalFileSystemPermissions {
                        ...
                        write: None,
                        glob_scan_max_depth: None,
                        entries: Some(vec![anecdoct_app_server_protocol::FileSystemSandboxEntry {
                            path: anecdoct_app_server_protocol::FileSystemPath::Special {
                                value: anecdoct_app_server_protocol::FileSystemSpecialPath::Root,
                            },
                            access: anecdoct_app_server_protocol::FileSystemAccessMode::Write,
