...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<anecdoct_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use anecdoct_app_server_protocol::HookEventName as AppServerHookEventName;
    use anecdoct_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use anecdoct_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use anecdoct_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use anecdoct_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use anecdoct_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use anecdoct_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use anecdoct_app_server_protocol::HookScope as AppServerHookScope;
