...
mod tests {
    ...
    use anecdoct_app_server_protocol::PermissionGrantScope;
    use anecdoct_app_server_protocol::PermissionsRequestApprovalParams;
    use anecdoct_app_server_protocol::PermissionsRequestApprovalResponse;
    use anecdoct_app_server_protocol::RequestId as AppServerRequestId;
    use anecdoct_app_server_protocol::ServerRequest;
    use anecdoct_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: anecdoct_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: anecdoct_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: anecdoct_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        entries: Some(vec![
                            anecdoct_app_server_protocol::FileSystemSandboxEntry {
                                path: anecdoct_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path),
                                },
                                access: anecdoct_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            anecdoct_app_server_protocol::FileSystemSandboxEntry {
                                path: anecdoct_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path),
                                },
                                access: anecdoct_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: anecdoct_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: anecdoct_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason:
                        anecdoct_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
