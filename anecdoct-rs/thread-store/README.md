...
`anecdoct-thread-store` is the storage boundary for Anecdoct threads. It defines the
...
- `LocalThreadStore` persists history through `anecdoct-rollout` JSONL files and
