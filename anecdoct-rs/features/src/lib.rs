...
pub enum Feature {
    ...
    ChildAgentsMd,
    /// Compress request bodies (zstd) when sending streaming requests to anecdoct-backend.
    ...
    PluginSharing,
    /// Show the startup prompt for migrating external agent config into Anecdoct.
    ExternalMigration,
    ...
    /// Prompt Anecdoct Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://developers.lambogenius.com/anecdoct/config-basic#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            menu_description: "Rebuild Anecdoct-owned transcript scrollback when the terminal width changes.",
            announcement: "",
        },
        default_enabled: true,
    },
    ...
    FeatureSpec {
        id: Feature::AnecdoctGitCommit,
        key: "anecdoct_git_commit",
        stage: Stage::Removed,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Memories",
            menu_description: "Allow Anecdoct to create new memories from conversations and bring relevant memories into new conversations.",
            announcement: "NEW: Anecdoct can now generate and use memories. Try it now with `/memories`",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart Anecdoct after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            menu_description: "Show a startup prompt when Anecdoct detects migratable external agent config for this machine or project.",
            announcement: "",
        },
        default_enabled: false,
    },
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Goals",
            menu_description: "Set a persistent goal Anecdoct can continue over time",
            announcement: "",
        },
        default_enabled: false,
    },
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while Anecdoct is running a thread.",
