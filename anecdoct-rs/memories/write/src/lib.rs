//! Write-path implementation for Anecdoct memories.
//!
...
mod guard_limits {
    pub(super) const ANECDOCT_LIMIT_ID: &str = "anecdoct";
}
...
mod stage_one {
    ...
    pub(super) const REASONING_EFFORT: anecdoct_protocol::lambogenius_models::ReasoningEffort =
        anecdoct_protocol::lambogenius_models::ReasoningEffort::Low;
