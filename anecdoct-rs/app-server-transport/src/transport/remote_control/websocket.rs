...
pub(super) const REMOTE_CONTROL_INSTALLATION_ID_HEADER: &str = "x-anecdoct-installation-id";
const REMOTE_CONTROL_SUBSCRIBE_CURSOR_HEADER: &str = "x-anecdoct-subscribe-cursor";
...
fn build_remote_control_websocket_request(
    ...
    set_remote_control_header(headers, "x-anecdoct-server-id", &enrollment.server_id)?;
...
pub(crate) async fn load_remote_control_auth(
    ...
    Ok(RemoteControlConnectionAuth {
        auth_provider: anecdoct_model_provider::auth_provider_from_auth(&auth),
