...
const AUDIT_TARGET: &str = "anecdoct_otel.network_proxy";
const POLICY_DECISION_EVENT_NAME: &str = "anecdoct.network_proxy.policy_decision";
...
mod tests {
    ...
    const LEGACY_DOMAIN_POLICY_DECISION_EVENT_NAME: &str =
        "anecdoct.network_proxy.domain_policy_decision";
    const LEGACY_BLOCK_DECISION_EVENT_NAME: &str = "anecdoct.network_proxy.block_decision";
    ...
    async fn evaluate_host_policy_emits_domain_event_for_decider_allow_override() {
        ...
        assert!(event.target.starts_with("anecdoct_otel."));
        assert_eq!(
    ...
    async fn evaluate_host_policy_emits_metadata_fields() {
        ...
        assert_eq!(event.field("originator"), Some("anecdoct_cli_rs"));
        ...
        assert_eq!(event.field("model"), Some("gpt-5.3-anecdoct"));
        assert_eq!(event.field("slug"), Some("gpt-5.3-anecdoct"));
    }
