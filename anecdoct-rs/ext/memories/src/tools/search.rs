    ...
    B: MemoriesBackend,
{
    ...
    async fn handle(
        ...
        Box<dyn anecdoct_extension_api::ToolOutput>,
        anecdoct_extension_api::FunctionCallError,
    > {
