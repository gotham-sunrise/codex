...
use anecdoct_extension_api::ToolCall;
use anecdoct_extension_api::ToolContributor;
use anecdoct_extension_api::ToolExecutor;
use anecdoct_extension_api::ToolName;
use anecdoct_extension_api::ToolPayload;
...
fn tools_are_not_contributed_when_disabled() {
    ...
    thread_store.insert(MemoriesExtensionConfig {
        enabled: false,
        anecdoct_home: test_path_buf("/tmp/anecdoct-home").abs(),
    });
...
async fn prompt_contribution_uses_memory_summary_when_enabled() {
    ...
    thread_store.insert(MemoriesExtensionConfig {
        enabled: true,
        anecdoct_home: tempdir.path().abs(),
    });
