...
mod tests {
    ...
    use anecdoct_config::ThreadConfigContext;
    use anecdoct_config::ThreadConfigLoadError;
    use anecdoct_config::ThreadConfigLoadErrorCode;
    ...
    async fn refresh_test_state() -> anyhow::Result<(
        ...
        let auth_manager = AuthManager::from_auth_for_testing(AnecdoctAuth::from_api_key("dummy"));
