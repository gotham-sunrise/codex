...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: anecdoct_app_server_protocol::Thread,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<AnecdoctThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<AnecdoctThread>) -> bool {
