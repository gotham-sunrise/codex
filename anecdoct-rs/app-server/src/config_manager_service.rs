...
use anecdoct_app_server_protocol::Config as ApiConfig;
use anecdoct_app_server_protocol::ConfigBatchWriteParams;
use anecdoct_app_server_protocol::ConfigLayerMetadata;
...
use anecdoct_app_server_protocol::OverriddenMetadata;
...
use anecdoct_config::merge_toml_values;
use anecdoct_core::config::deserialize_config_toml_with_base;
use anecdoct_core::config::edit::ConfigEdit;
use anecdoct_core::config::edit::ConfigEditsBuilder;
use anecdoct_core::config::validate_feature_requirements_for_config_toml;
use anecdoct_core::path_utils;
use anecdoct_core::path_utils::SymlinkWritePaths;
use anecdoct_core::path_utils::resolve_symlink_write_paths;
use anecdoct_core::path_utils::write_atomically;
...
impl ConfigManager {
    ...
    async fn apply_edits(
        ...
        let user_config_toml =
            deserialize_config_toml_with_base(user_config.clone(), self.anecdoct_home()).map_err(
                |err| {
                    ConfigManagerError::write(
                        ConfigWriteErrorCode::ConfigValidationError,
                        format!("Invalid configuration: {err}"),
    ...
    /// include any in-repo .anecdoct/ folders because there is no cwd/project root
