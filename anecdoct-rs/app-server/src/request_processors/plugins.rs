...
use anecdoct_app_server_protocol::PluginAvailability;
use anecdoct_app_server_protocol::PluginInstallPolicy;
use anecdoct_app_server_protocol::PluginSharePrincipalRole;
use anecdoct_app_server_protocol::PluginShareTargetRole;
use anecdoct_config::types::McpServerConfig;
use anecdoct_core_plugins::remote::is_valid_remote_plugin_id;
use anecdoct_core_plugins::remote::validate_remote_plugin_id;
use anecdoct_mcp::McpOAuthLoginSupport;
use anecdoct_mcp::oauth_login_support;
use anecdoct_mcp::should_retry_without_scopes;
use anecdoct_rmcp_client::perform_oauth_login_silent;
...
fn plugin_skills_to_info(
    skills: &[anecdoct_core::skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                anecdoct_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    anecdoct_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
        config.anecdoct_home.as_path(),
    )
    .map_err(|err| {
...
) -> anecdoct_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            anecdoct_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            anecdoct_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            anecdoct_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> anecdoct_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Unlisted => {
            anecdoct_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            anecdoct_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> anecdoct_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            anecdoct_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            anecdoct_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: anecdoct_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        anecdoct_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        anecdoct_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        anecdoct_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<anecdoct_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| anecdoct_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        anecdoct_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        anecdoct_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        anecdoct_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: anecdoct_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    ...
    async fn workspace_anecdoct_plugins_enabled(
        &self,
        config: &Config,
        auth: Option<&AnecdoctAuth>,
    ) -> bool {
        match workspace_settings::anecdoct_plugins_enabled_for_workspace(
            config,
            auth,
        ...
        .await
        {
            ...
            Err(err) => {
                warn!(
                    "failed to fetch workspace Anecdoct plugins setting; allowing Anecdoct plugins: {err:#}"
                );
                true
            }
        }
    ...
    async fn plugin_list_response(
        ...
        if !self
            .workspace_anecdoct_plugins_enabled(&config, auth.as_ref())
            .await
        {
            return Ok(empty_response());
        }
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<anecdoct_app_server_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        ...
                        .into_iter()
                        .map(
                            |err| anecdoct_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if !remote_sources.is_empty() {
            ...
            match anecdoct_core_plugins::remote::fetch_remote_marketplaces(
        ...
        let featured_plugin_ids = if data
            .iter()
            .any(|marketplace| marketplace.name == LAMBOGENIUS_CURATED_MARKETPLACE_NAME)
        {
    ...
    async fn plugin_read_response(
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        ...
                        match anecdoct_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| anecdoct_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = anecdoct_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(anecdoct_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
                let environment_manager = self.thread_manager.environment_manager();
                let app_summaries =
    ...
    async fn plugin_skill_read_response(
        ...
        let remote_skill_detail = anecdoct_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let access_policy = anecdoct_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = anecdoct_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.anecdoct_home.as_path(),
            &plugin_path,
    ...
    async fn plugin_share_update_targets_response(
        ...
        let result = anecdoct_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let data = anecdoct_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.anecdoct_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let result = anecdoct_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.anecdoct_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        anecdoct_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.anecdoct_home.as_path(),
            &remote_plugin_id,
    ...
    async fn load_plugin_share_config_and_auth(
        &self,
    ) -> Result<(Config, Option<AnecdoctAuth>), JSONRPCErrorError> {
        let config = self.load_latest_config(/*fallback_cwd*/ None).await?;
        if !config.features.enabled(Feature::Plugins) {
    ...
    async fn plugin_install_response(
        ...
        {
            return Err(invalid_request(
                "Anecdoct plugins are disabled for this workspace",
            ));
        }
        ...
        let apps_needing_auth = self
            .plugin_apps_needing_auth_for_install(
                &config,
                auth.as_ref().is_some_and(AnecdoctAuth::is_chatgpt_auth),
    ...
    async fn remote_plugin_install_response(
        ...
        let remote_detail =
            anecdoct_core_plugins::remote::fetch_remote_plugin_detail_with_download_urls(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
        ...
        let _remote_plugin_cache_mutation =
            anecdoct_core_plugins::remote::mark_remote_plugin_cache_mutation_in_flight(
                config.anecdoct_home.as_path(),
                &actual_remote_marketplace_name,
                &remote_detail.summary.name,
            );
        let validated_bundle = anecdoct_core_plugins::remote_bundle::validate_remote_plugin_bundle(
            &remote_plugin_id,
            &actual_remote_marketplace_name,
            &remote_detail.summary.name,
        ...
        let result =
            anecdoct_core_plugins::remote_bundle::download_and_install_remote_plugin_bundle(
        ...
        anecdoct_core_plugins::remote::install_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            &actual_remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        plugin_id: &str,
        plugin_apps: &[anecdoct_plugin::AppConnectorId],
    ) -> Vec<AppSummary> {
        ...
        let (accessible_connectors, anecdoct_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.anecdoct_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !anecdoct_apps_ready {
            warn!(
                plugin = plugin_id,
                "anecdoct_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if anecdoct_plugin::PluginId::parse(&plugin_id).is_err()
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let uninstall_result = anecdoct_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.anecdoct_home.to_path_buf(),
            &plugin_id,
...
async fn load_plugin_app_summaries(
    ...
    let accessible_connectors =
        ...
        .await
        {
            Ok(status) if status.anecdoct_apps_ready => status.connectors,
            Ok(_) => {
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: anecdoct_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: anecdoct_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
