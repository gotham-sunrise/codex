...
use anecdoct_app_server_protocol::AccountRateLimitsUpdatedNotification;
use anecdoct_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use anecdoct_app_server_protocol::AnecdoctErrorInfo as V2AnecdoctErrorInfo;
use anecdoct_app_server_protocol::CommandAction as V2ParsedCommand;
use anecdoct_app_server_protocol::CommandExecutionApprovalDecision;
use anecdoct_app_server_protocol::CommandExecutionRequestApprovalParams;
use anecdoct_app_server_protocol::CommandExecutionRequestApprovalResponse;
use anecdoct_app_server_protocol::CommandExecutionSource;
use anecdoct_app_server_protocol::CommandExecutionStatus;
use anecdoct_app_server_protocol::DeprecationNoticeNotification;
use anecdoct_app_server_protocol::DynamicToolCallParams;
use anecdoct_app_server_protocol::DynamicToolCallStatus;
use anecdoct_app_server_protocol::ErrorNotification;
use anecdoct_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use anecdoct_app_server_protocol::FileChangeApprovalDecision;
use anecdoct_app_server_protocol::FileChangeRequestApprovalParams;
use anecdoct_app_server_protocol::FileChangeRequestApprovalResponse;
use anecdoct_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use anecdoct_app_server_protocol::GuardianWarningNotification;
use anecdoct_app_server_protocol::HookCompletedNotification;
use anecdoct_app_server_protocol::HookStartedNotification;
use anecdoct_app_server_protocol::ItemCompletedNotification;
use anecdoct_app_server_protocol::ItemStartedNotification;
use anecdoct_app_server_protocol::McpServerElicitationAction;
use anecdoct_app_server_protocol::McpServerElicitationRequestParams;
use anecdoct_app_server_protocol::McpServerElicitationRequestResponse;
use anecdoct_app_server_protocol::McpServerStartupState;
use anecdoct_app_server_protocol::McpServerStatusUpdatedNotification;
use anecdoct_app_server_protocol::ModelReroutedNotification;
use anecdoct_app_server_protocol::ModelVerificationNotification;
use anecdoct_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use anecdoct_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use anecdoct_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use anecdoct_app_server_protocol::PermissionsRequestApprovalParams;
use anecdoct_app_server_protocol::PermissionsRequestApprovalResponse;
use anecdoct_app_server_protocol::RawResponseItemCompletedNotification;
use anecdoct_app_server_protocol::RequestId;
use anecdoct_app_server_protocol::ServerNotification;
use anecdoct_app_server_protocol::ServerRequestPayload;
use anecdoct_app_server_protocol::ThreadGoalUpdatedNotification;
use anecdoct_app_server_protocol::ThreadItem;
use anecdoct_app_server_protocol::ThreadRealtimeClosedNotification;
use anecdoct_app_server_protocol::ThreadRealtimeErrorNotification;
use anecdoct_app_server_protocol::ThreadRealtimeItemAddedNotification;
use anecdoct_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use anecdoct_app_server_protocol::ThreadRealtimeSdpNotification;
use anecdoct_app_server_protocol::ThreadRealtimeStartedNotification;
use anecdoct_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use anecdoct_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use anecdoct_app_server_protocol::ThreadRollbackResponse;
use anecdoct_app_server_protocol::ThreadStatus;
use anecdoct_app_server_protocol::ThreadTokenUsage;
use anecdoct_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use anecdoct_app_server_protocol::ToolRequestUserInputOption;
use anecdoct_app_server_protocol::ToolRequestUserInputParams;
use anecdoct_app_server_protocol::ToolRequestUserInputQuestion;
use anecdoct_app_server_protocol::ToolRequestUserInputResponse;
use anecdoct_app_server_protocol::Turn;
use anecdoct_app_server_protocol::TurnCompletedNotification;
use anecdoct_app_server_protocol::TurnDiffUpdatedNotification;
...
use anecdoct_app_server_protocol::TurnPlanStep;
use anecdoct_app_server_protocol::TurnPlanUpdatedNotification;
use anecdoct_app_server_protocol::TurnStartedNotification;
use anecdoct_app_server_protocol::TurnStatus;
use anecdoct_app_server_protocol::WarningNotification;
use anecdoct_app_server_protocol::build_item_from_guardian_event;
use anecdoct_app_server_protocol::guardian_auto_approval_review_notification;
use anecdoct_app_server_protocol::item_event_to_server_notification;
use anecdoct_core::AnecdoctThread;
use anecdoct_core::ThreadManager;
use anecdoct_core::review_format::format_review_findings_block;
use anecdoct_core::review_prompts;
use anecdoct_protocol::ThreadId;
use anecdoct_protocol::items::parse_hook_prompt_message;
use anecdoct_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use anecdoct_protocol::plan_tool::UpdatePlanArgs;
use anecdoct_protocol::protocol::AnecdoctErrorInfo as CoreAnecdoctErrorInfo;
use anecdoct_protocol::protocol::Event;
use anecdoct_protocol::protocol::EventMsg;
use anecdoct_protocol::protocol::ExecApprovalRequestEvent;
use anecdoct_protocol::protocol::Op;
use anecdoct_protocol::protocol::RealtimeEvent;
use anecdoct_protocol::protocol::ReviewDecision;
use anecdoct_protocol::protocol::ReviewOutputEvent;
...
use anecdoct_protocol::protocol::TurnDiffEvent;
use anecdoct_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use anecdoct_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use anecdoct_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use anecdoct_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use anecdoct_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use anecdoct_sandboxing::policy_transforms::intersect_permission_profiles;
use anecdoct_shell_command::parse_command::shlex_join;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<AnecdoctThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error) = match update.status {
                anecdoct_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None)
                }
                anecdoct_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None)
                }
                anecdoct_protocol::protocol::McpStartupStatus::Failed { error } => {
                    (McpServerStartupState::Failed, Some(error))
                }
                anecdoct_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status
                == anecdoct_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                anecdoct_protocol::protocol::GuardianAssessmentStatus::Denied
                | anecdoct_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                anecdoct_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                anecdoct_protocol::protocol::GuardianAssessmentStatus::InProgress
                | anecdoct_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: anecdoct_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let anecdoct_error_info = ev.anecdoct_error_info.clone();
            ...
            if matches!(
                anecdoct_error_info,
                Some(CoreAnecdoctErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                anecdoct_error_info: ev.anecdoct_error_info.map(V2AnecdoctErrorInfo::from),
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(
                ...
                anecdoct_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
            ) {
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: anecdoct_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let anecdoct_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(anecdoct_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: anecdoct_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: anecdoct_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<AnecdoctThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: anecdoct_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            anecdoct_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use anecdoct_app_server_protocol::AutoReviewDecisionSource;
    use anecdoct_app_server_protocol::GuardianApprovalReviewStatus;
    use anecdoct_app_server_protocol::JSONRPCErrorError;
    use anecdoct_app_server_protocol::TurnPlanStepStatus;
    use anecdoct_login::AnecdoctAuth;
    use anecdoct_protocol::items::HookPromptFragment;
    use anecdoct_protocol::items::build_hook_prompt_message;
    use anecdoct_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use anecdoct_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use anecdoct_protocol::plan_tool::PlanItemArg;
    use anecdoct_protocol::plan_tool::StepStatus;
    use anecdoct_protocol::protocol::AgentMessageEvent;
    use anecdoct_protocol::protocol::AskForApproval;
    use anecdoct_protocol::protocol::CreditsSnapshot;
    use anecdoct_protocol::protocol::EventMsg;
    use anecdoct_protocol::protocol::GuardianAssessmentEvent;
    use anecdoct_protocol::protocol::GuardianAssessmentStatus;
    ...
    use anecdoct_utils_absolute_path::AbsolutePathBuf;
    use anecdoct_utils_absolute_path::test_support::PathBufExt;
    use anecdoct_utils_absolute_path::test_support::test_path_buf;
    use anyhow::Result;
    use anyhow::anyhow;
    use anyhow::bail;
    use chrono::Utc;
    ...
    fn rollback_response_rebuilds_pathless_thread_from_stored_history() -> Result<()> {
        ...
        let stored_thread = StoredThread {
            ...
            model_provider: "lambogenius".to_string(),
            model: None,
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: anecdoct_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(anecdoct_protocol::protocol::GuardianRiskLevel::Low),
                Some(anecdoct_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(anecdoct_protocol::protocol::GuardianRiskLevel::High),
                Some(anecdoct_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(anecdoct_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = anecdoct_protocol::protocol::GuardianAssessmentAction::Command {
            source: anecdoct_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: anecdoct_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: anecdoct_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(anecdoct_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(
                    anecdoct_protocol::protocol::GuardianUserAuthorization::Low,
                ),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    anecdoct_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(anecdoct_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(anecdoct_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = anecdoct_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.lambogenius.com:443".to_string(),
            host: "api.lambogenius.com".to_string(),
            protocol: anecdoct_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: anecdoct_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            anecdoct_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&anecdoct_home).await;
        let thread_manager = Arc::new(
            anecdoct_core::test_support::thread_manager_with_models_provider_and_home(
                AnecdoctAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.anecdoct_home.to_path_buf(),
                Arc::new(anecdoct_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let anecdoct_core::NewThread {
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                anecdoct_error_info: Some(V2AnecdoctErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(anecdoct_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(anecdoct_protocol::protocol::UserMessageEvent {
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(anecdoct_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    started_at: Some(42),
                    model_context_window: None,
                    collaboration_mode_kind: Default::default(),
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                anecdoct_error_info: Some(V2AnecdoctErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("anecdoct"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                anecdoct_error_info: Some(V2AnecdoctErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            anecdoct_app_server_protocol::HookPromptFragment {
