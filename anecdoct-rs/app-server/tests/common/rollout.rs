...
pub fn rollout_path(anecdoct_home: &Path, filename_ts: &str, thread_id: &str) -> PathBuf {
...
/// Create a minimal rollout file under `ANECDOCT_HOME/sessions/YYYY/MM/DD/`.
///
...
pub fn create_fake_rollout_with_token_usage(
    ...
    let file_path = rollout_path(anecdoct_home, filename_ts, &thread_id);
    let line = json!({
...
pub fn create_fake_rollout_with_source(
    ...
    let file_path = rollout_path(anecdoct_home, filename_ts, &uuid_str);
    let dir = file_path
        .parent()
