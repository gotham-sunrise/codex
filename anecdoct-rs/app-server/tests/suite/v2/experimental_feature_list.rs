...
use anecdoct_app_server_protocol::ExperimentalFeature;
...
use anecdoct_app_server_protocol::ExperimentalFeatureStage;
...
-> Result<()> {
    let anecdoct_home = TempDir::new()?;
    let project_cwd = anecdoct_home.path().join("project");
