...
use anecdoct_app_server_protocol::Model;
use anecdoct_app_server_protocol::ModelListParams;
use anecdoct_app_server_protocol::ModelListResponse;
use anecdoct_app_server_protocol::ModelServiceTier;
use anecdoct_app_server_protocol::ModelUpgradeInfo;
use anecdoct_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        anecdoct_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
...
lambogenius_base_url = "{server_uri}/v1"
"#
        ),
    )?;
    write_chatgpt_auth(
