...
use anecdoct_app_server_protocol::AppBranding;
use anecdoct_app_server_protocol::AppInfo;
use anecdoct_app_server_protocol::AppListUpdatedNotification;
use anecdoct_app_server_protocol::AppMetadata;
use anecdoct_app_server_protocol::AppReview;
use anecdoct_app_server_protocol::AppScreenshot;
...
async fn list_apps_returns_empty_with_api_key_auth() -> Result<()> {
    ...
    save_auth(
        ...
        &AuthDotJson {
            ...
            lambogenius_api_key: Some("test-api-key".to_string()),
            tokens: None,
            last_refresh: None,
            agent_identity: None,
        },
...
#[tokio::test]
async fn list_apps_returns_empty_when_workspace_anecdoct_plugins_disabled() -> Result<()> {
    let connectors = vec![AppInfo {
        id: "beta".to_string(),
        name: "Beta".to_string(),
        description: Some("Beta connector".to_string()),
