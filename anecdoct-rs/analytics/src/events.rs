...
use anecdoct_protocol::models::SandboxPermissions;
use anecdoct_protocol::protocol::GuardianAssessmentOutcome;
use anecdoct_protocol::protocol::GuardianCommandSource;
use anecdoct_protocol::protocol::GuardianRiskLevel;
use anecdoct_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(AnecdoctAppMentionedEventRequest),
    AppUsed(AnecdoctAppUsedEventRequest),
    HookRun(AnecdoctHookRunEventRequest),
    Compaction(Box<AnecdoctCompactionEventRequest>),
    TurnEvent(Box<AnecdoctTurnEventRequest>),
    TurnSteer(AnecdoctTurnSteerEventRequest),
    CommandExecution(AnecdoctCommandExecutionEventRequest),
    FileChange(AnecdoctFileChangeEventRequest),
    McpToolCall(AnecdoctMcpToolCallEventRequest),
    DynamicToolCall(AnecdoctDynamicToolCallEventRequest),
    CollabAgentToolCall(AnecdoctCollabAgentToolCallEventRequest),
    WebSearch(AnecdoctWebSearchEventRequest),
    ImageGeneration(AnecdoctImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<AnecdoctAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(AnecdoctReviewEventRequest),
    PluginUsed(AnecdoctPluginUsedEventRequest),
    PluginInstalled(AnecdoctPluginEventRequest),
    PluginUninstalled(AnecdoctPluginEventRequest),
    PluginEnabled(AnecdoctPluginEventRequest),
    PluginDisabled(AnecdoctPluginEventRequest),
}
...
#[derive(Serialize)]
pub(crate) struct AnecdoctAcceptedLineFingerprintsEventParams {
...
#[derive(Serialize)]
pub(crate) struct AnecdoctAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct AnecdoctAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct AnecdoctRuntimeMetadata {
    pub(crate) anecdoct_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    pub(crate) thread_id: String,
    pub(crate) app_server_client: AnecdoctAppServerClientMetadata,
    pub(crate) runtime: AnecdoctRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Anecdoct turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct AnecdoctCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: AnecdoctToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: AnecdoctToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AnecdoctToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AnecdoctToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AnecdoctToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: AnecdoctToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: AnecdoctToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctAppMetadata {
...
#[derive(Serialize)]
pub(crate) struct AnecdoctAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: AnecdoctAppServerClientMetadata,
    pub(crate) runtime: AnecdoctRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<AnecdoctErrorInfo>,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctTurnSteerEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctPluginMetadata {
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AnecdoctPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: AnecdoctPluginMetadata,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
}
...
#[derive(Serialize)]
pub(crate) struct AnecdoctPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct AnecdoctPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AnecdoctPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "anecdoct_plugin_installed",
        PluginState::Uninstalled => "anecdoct_plugin_uninstalled",
        PluginState::Enabled => "anecdoct_plugin_enabled",
        PluginState::Disabled => "anecdoct_plugin_disabled",
    }
}

pub(crate) fn anecdoct_app_metadata(
...
pub(crate) fn anecdoct_plugin_metadata(plugin: PluginTelemetryMetadata) -> AnecdoctPluginMetadata {
...
pub(crate) fn anecdoct_compaction_event_params(
...
pub(crate) fn anecdoct_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> AnecdoctPluginUsedMetadata {
    AnecdoctPluginUsedMetadata {
        plugin: anecdoct_plugin_metadata(plugin),
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
    }
...
pub(crate) fn anecdoct_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> AnecdoctHookRunMetadata {
    AnecdoctHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
...
pub(crate) fn current_runtime_metadata() -> AnecdoctRuntimeMetadata {
    let os_info = os_info::get();
    AnecdoctRuntimeMetadata {
        anecdoct_rs_version: env!("CARGO_PKG_VERSION").to_string(),
