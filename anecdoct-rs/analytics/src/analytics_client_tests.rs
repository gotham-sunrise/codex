...
use crate::events::AnecdoctAcceptedLineFingerprintsEventParams;
use crate::events::AnecdoctAcceptedLineFingerprintsEventRequest;
use crate::events::AnecdoctAppMentionedEventRequest;
use crate::events::AnecdoctAppServerClientMetadata;
use crate::events::AnecdoctAppUsedEventRequest;
use crate::events::AnecdoctCommandExecutionEventParams;
use crate::events::AnecdoctCommandExecutionEventRequest;
use crate::events::AnecdoctCompactionEventRequest;
use crate::events::AnecdoctHookRunEventRequest;
use crate::events::AnecdoctPluginEventRequest;
use crate::events::AnecdoctPluginUsedEventRequest;
use crate::events::AnecdoctReviewEventParams;
use crate::events::AnecdoctReviewEventRequest;
use crate::events::AnecdoctRuntimeMetadata;
use crate::events::AnecdoctToolItemEventBase;
use crate::events::AnecdoctTurnEventRequest;
...
use crate::events::anecdoct_app_metadata;
use crate::events::anecdoct_hook_run_metadata;
use crate::events::anecdoct_plugin_metadata;
use crate::events::anecdoct_plugin_used_metadata;
use crate::events::subagent_thread_started_event_request;
use crate::facts::AnalyticsFact;
use crate::facts::AnalyticsJsonRpcError;
use crate::facts::AnecdoctCompactionEvent;
...
use anecdoct_app_server_protocol::ApprovalsReviewer as AppServerApprovalsReviewer;
use anecdoct_app_server_protocol::AskForApproval as AppServerAskForApproval;
...
use anecdoct_app_server_protocol::CollabAgentTool;
use anecdoct_app_server_protocol::CollabAgentToolCallStatus;
use anecdoct_app_server_protocol::CommandAction;
...
use anecdoct_app_server_protocol::GuardianApprovalReview;
use anecdoct_app_server_protocol::GuardianApprovalReviewAction;
use anecdoct_app_server_protocol::GuardianApprovalReviewStatus;
use anecdoct_app_server_protocol::GuardianCommandSource as AppServerGuardianCommandSource;
use anecdoct_app_server_protocol::InitializeCapabilities;
use anecdoct_app_server_protocol::InitializeParams;
use anecdoct_app_server_protocol::ItemCompletedNotification;
use anecdoct_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
use anecdoct_app_server_protocol::ItemStartedNotification;
use anecdoct_app_server_protocol::JSONRPCErrorError;
use anecdoct_app_server_protocol::McpToolCallStatus;
use anecdoct_app_server_protocol::NonSteerableTurnKind;
use anecdoct_app_server_protocol::PatchApplyStatus;
use anecdoct_app_server_protocol::PermissionsRequestApprovalParams;
use anecdoct_app_server_protocol::RequestId;
use anecdoct_app_server_protocol::RequestPermissionProfile;
use anecdoct_app_server_protocol::SandboxPolicy as AppServerSandboxPolicy;
use anecdoct_app_server_protocol::ServerNotification;
use anecdoct_app_server_protocol::ServerRequest;
use anecdoct_app_server_protocol::ServerResponse;
use anecdoct_app_server_protocol::SessionSource as AppServerSessionSource;
...
use anecdoct_app_server_protocol::ThreadSource as AppServerThreadSource;
use anecdoct_app_server_protocol::ThreadStartResponse;
use anecdoct_app_server_protocol::ThreadStatus as AppServerThreadStatus;
...
use anecdoct_app_server_protocol::TurnError as AppServerTurnError;
use anecdoct_app_server_protocol::TurnStartParams;
use anecdoct_app_server_protocol::TurnStartedNotification;
use anecdoct_app_server_protocol::TurnStatus as AppServerTurnStatus;
use anecdoct_app_server_protocol::TurnSteerParams;
use anecdoct_app_server_protocol::TurnSteerResponse;
use anecdoct_app_server_protocol::UserInput;
use anecdoct_login::default_client::DEFAULT_ORIGINATOR;
use anecdoct_login::default_client::originator;
use anecdoct_plugin::AppConnectorId;
use anecdoct_plugin::PluginCapabilitySummary;
use anecdoct_plugin::PluginId;
use anecdoct_plugin::PluginTelemetryMetadata;
use anecdoct_protocol::approvals::NetworkApprovalProtocol;
...
use anecdoct_protocol::models::PermissionProfile as CorePermissionProfile;
use anecdoct_protocol::protocol::AskForApproval;
use anecdoct_protocol::protocol::HookEventName;
use anecdoct_protocol::protocol::HookRunStatus;
use anecdoct_protocol::protocol::HookSource;
use anecdoct_protocol::protocol::SessionSource;
use anecdoct_protocol::protocol::SubAgentSource;
...
fn sample_app_server_client_metadata() -> AnecdoctAppServerClientMetadata {
    AnecdoctAppServerClientMetadata {
        product_client_id: DEFAULT_ORIGINATOR.to_string(),
        client_name: Some("anecdoct-tui".to_string()),
...
fn sample_runtime_metadata() -> AnecdoctRuntimeMetadata {
    AnecdoctRuntimeMetadata {
        anecdoct_rs_version: "0.1.0".to_string(),
...
fn sample_turn_start_response(turn_id: &str) -> ClientResponsePayload {
    ClientResponsePayload::TurnStart(anecdoct_app_server_protocol::TurnStartResponse {
        turn: Turn {
            id: turn_id.to_string(),
            items_view: anecdoct_app_server_protocol::TurnItemsView::Full,
            items: vec![],
...
fn sample_turn_completed_notification(
    ...
    anecdoct_error_info: Option<anecdoct_app_server_protocol::AnecdoctErrorInfo>,
) -> ServerNotification {
    ServerNotification::TurnCompleted(TurnCompletedNotification {
        ...
        turn: Turn {
            ...
            items: vec![],
            status,
            error: anecdoct_error_info.map(|anecdoct_error_info| AppServerTurnError {
                message: "turn failed".to_string(),
                anecdoct_error_info: Some(anecdoct_error_info),
    ...
    JSONRPCErrorError {
        ...
        data: Some(
            serde_json::to_value(AppServerTurnError {
                message: "cannot steer a review turn".to_string(),
                anecdoct_error_info: Some(AnecdoctErrorInfo::ActiveTurnNotSteerable {
            ...
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "anecdoct-web".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "anecdoct-web".to_string(),
    ...
    reducer
        .ingest(
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "anecdoct-tui".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "anecdoct-tui".to_string(),
                runtime: sample_runtime_metadata(),
                rpc_transport: AppServerRpcTransport::Stdio,
            },
            out,
...
fn sample_initialize_fact(connection_id: u64) -> AnalyticsFact {
    AnalyticsFact::Initialize {
        ...
        product_client_id: DEFAULT_ORIGINATOR.to_string(),
        runtime: AnecdoctRuntimeMetadata {
            anecdoct_rs_version: "0.99.0".to_string(),
    ...
    ServerRequest::PermissionsRequestApproval {
        ...
        params: PermissionsRequestApprovalParams {
            ...
            permissions: RequestPermissionProfile {
                network: Some(anecdoct_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: None,
            },
...
fn sample_guardian_review_completed(
    ...
    ServerNotification::ItemGuardianApprovalReviewCompleted(
        ItemGuardianApprovalReviewCompletedNotification {
            ...
            decision_source: anecdoct_app_server_protocol::AutoReviewDecisionSource::Agent,
...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.anecdoct/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".anecdoct/skills/doc/SKILL.md");
}

#[test]
fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/Users/abc/.anecdoct/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_admin_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/etc/anecdoct/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.anecdoct/skills/doc/SKILL.md");
...
fn app_mentioned_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppMentioned(AnecdoctAppMentionedEventRequest {
        event_type: "anecdoct_app_mentioned",
        event_params: anecdoct_app_metadata(
            &tracking,
            AppInvocation {
...
fn app_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppUsed(AnecdoctAppUsedEventRequest {
        event_type: "anecdoct_app_used",
        event_params: anecdoct_app_metadata(
            &tracking,
            AppInvocation {
...
fn accepted_line_fingerprints_event_serializes_expected_shape() {
    let event = TrackEventRequest::AcceptedLineFingerprints(Box::new(
        AnecdoctAcceptedLineFingerprintsEventRequest {
            event_type: "anecdoct_accepted_line_fingerprints",
            event_params: AnecdoctAcceptedLineFingerprintsEventParams {
                event_type: "anecdoct.accepted_line_fingerprints",
                turn_id: "turn-1".to_string(),
                thread_id: "thread-1".to_string(),
                product_surface: Some("anecdoct".to_string()),
                model_slug: Some("gpt-5.1-anecdoct".to_string()),
    ...
    assert_eq!(
        ...
        json!({
            ...
            "event_params": {
                ...
                "turn_id": "turn-1",
                "thread_id": "thread-1",
                "product_surface": "anecdoct",
                "model_slug": "gpt-5.1-anecdoct",
                "completed_at": 1710000000,
...
fn compaction_event_serializes_expected_shape() {
    let event = TrackEventRequest::Compaction(Box::new(AnecdoctCompactionEventRequest {
        event_type: "anecdoct_compaction_event",
        event_params: crate::events::anecdoct_compaction_event_params(
            AnecdoctCompactionEvent {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
        ...
        json!({
            ...
            "event_params": {
                ...
                "app_server_client": {
                    ...
                    "client_name": "anecdoct-tui",
                    "client_version": "1.0.0",
                    "rpc_transport": "stdio",
                    "experimental_api_enabled": true
                },
                "runtime": {
                    "anecdoct_rs_version": "0.1.0",
                    "runtime_os": "macos",
...
fn thread_initialized_event_serializes_expected_shape() {
    let event = TrackEventRequest::ThreadInitialized(ThreadInitializedEvent {
        event_type: "anecdoct_thread_initialized",
        event_params: ThreadInitializedEventParams {
            thread_id: "thread-0".to_string(),
            app_server_client: AnecdoctAppServerClientMetadata {
                product_client_id: DEFAULT_ORIGINATOR.to_string(),
                client_name: Some("anecdoct-tui".to_string()),
                client_version: Some("1.0.0".to_string()),
                rpc_transport: AppServerRpcTransport::Stdio,
...
fn command_execution_event_serializes_expected_shape() {
    let event = TrackEventRequest::CommandExecution(AnecdoctCommandExecutionEventRequest {
        event_type: "anecdoct_command_execution_event",
        event_params: AnecdoctCommandExecutionEventParams {
            base: AnecdoctToolItemEventBase {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
                item_id: "item-1".to_string(),
                app_server_client: AnecdoctAppServerClientMetadata {
                    product_client_id: "anecdoct_tui".to_string(),
                    client_name: Some("anecdoct-tui".to_string()),
    ...
    assert_eq!(
        ...
        json!({
            ...
            "event_params": {
                ...
                "item_id": "item-1",
                "app_server_client": {
                    "product_client_id": "anecdoct_tui",
                    "client_name": "anecdoct-tui",
...
fn review_event_serializes_expected_shape() {
    let event = TrackEventRequest::ReviewEvent(AnecdoctReviewEventRequest {
        event_type: "anecdoct_review_event",
        event_params: AnecdoctReviewEventParams {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            item_id: None,
...
async fn initialize_caches_client_and_thread_lifecycle_publishes_once_initialized() {
    ...
    assert_eq!(payload[0]["event_type"], "anecdoct_thread_initialized");
    assert_eq!(
    ...
    assert_eq!(
        payload[0]["event_params"]["runtime"]["anecdoct_rs_version"],
        "0.99.0"
    );
...
async fn compaction_event_ingests_custom_fact() {
    ...
    let parent_thread_id =
        anecdoct_protocol::ThreadId::from_string("22222222-2222-2222-2222-222222222222")
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "anecdoct_compaction_event");
...
async fn guardian_review_event_ingests_custom_fact_with_optional_target_item() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "anecdoct_guardian_review");
...
async fn item_lifecycle_notifications_publish_command_execution_event() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "anecdoct_command_execution_event");
    assert_eq!(payload[0]["event_params"]["thread_id"], "thread-1");
...
async fn command_execution_approval_response_publishes_user_review_event() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "anecdoct_review_event");
    assert_eq!(payload[0]["event_params"]["thread_id"], "thread-1");
    assert_eq!(payload[0]["event_params"]["turn_id"], "turn-1");
    assert_eq!(payload[0]["event_params"]["item_id"], "item-1");
...
async fn guardian_completed_notification_publishes_review_event_with_thread_metadata() {
    ...
    assert_eq!(payload["event_type"], "anecdoct_review_event");
...
fn subagent_thread_started_review_serializes_expected_shape() {
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            ...
            parent_thread_id: None,
            product_client_id: "anecdoct-tui".to_string(),
            client_name: "anecdoct-tui".to_string(),
...
fn subagent_thread_started_thread_spawn_serializes_parent_thread_id() {
    let parent_thread_id =
        anecdoct_protocol::ThreadId::from_string("11111111-1111-1111-1111-111111111111")
...
async fn subagent_thread_started_inherits_parent_connection_for_new_thread() {
    ...
    let mut events = Vec::new();
    let parent_thread_id =
        anecdoct_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
            .expect("valid parent thread id");
...
fn plugin_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::PluginUsed(AnecdoctPluginUsedEventRequest {
        event_type: "anecdoct_plugin_used",
        event_params: anecdoct_plugin_used_metadata(&tracking, sample_plugin_metadata()),
    });
...
fn plugin_management_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstalled(AnecdoctPluginEventRequest {
        event_type: "anecdoct_plugin_installed",
        event_params: anecdoct_plugin_metadata(sample_plugin_metadata()),
    });
...
fn plugin_management_event_can_use_remote_plugin_id_override() {
    ...
    let event = TrackEventRequest::PluginInstalled(AnecdoctPluginEventRequest {
        event_type: "anecdoct_plugin_installed",
        event_params: anecdoct_plugin_metadata(plugin),
    });
...
fn hook_run_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::HookRun(AnecdoctHookRunEventRequest {
        event_type: "anecdoct_hook_run",
        event_params: anecdoct_hook_run_metadata(
            &tracking,
            HookRunFact {
...
fn hook_run_metadata_maps_sources_and_statuses() {
    ...
    let system = serde_json::to_value(anecdoct_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let project = serde_json::to_value(anecdoct_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let cloud_requirements = serde_json::to_value(anecdoct_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
    ...
    let unknown = serde_json::to_value(anecdoct_hook_run_metadata(
        &tracking,
        HookRunFact {
...
fn hook_run_metadata_maps_stopped_status() {
    ...
    let stopped = serde_json::to_value(anecdoct_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
            hook_source: HookSource::User,
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::SkillInvoked(SkillInvokedInput {
                ...
                invocations: vec![SkillInvocation {
                    ...
                    skill_scope: anecdoct_protocol::protocol::SkillScope::User,
                    skill_path,
                    plugin_id: None,
...
async fn reducer_includes_plugin_id_for_plugin_skill_invocations() {
    ...
    let skill_path =
        PathBuf::from("/Users/abc/.anecdoct/plugins/cache/test/sample/skills/doc/SKILL.md");
...
async fn reducer_ingests_hook_run_fact() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "anecdoct_hook_run");
...
async fn reducer_ingests_app_and_plugin_facts() {
    ...
    assert_eq!(payload[0]["event_type"], "anecdoct_app_mentioned");
    assert_eq!(payload[1]["event_type"], "anecdoct_app_used");
    assert_eq!(payload[2]["event_type"], "anecdoct_plugin_used");
}
...
async fn reducer_ingests_plugin_state_changed_fact() {
    ...
    assert_eq!(
        payload,
        json!([{
            "event_type": "anecdoct_plugin_disabled",
            "event_params": {
                "plugin_id": "sample@test",
                "plugin_name": "sample",
                "marketplace_name": "test",
...
fn turn_event_serializes_expected_shape() {
    let event = TrackEventRequest::TurnEvent(Box::new(AnecdoctTurnEventRequest {
        event_type: "anecdoct_turn_event",
        event_params: crate::events::AnecdoctTurnEventParams {
            thread_id: "thread-2".to_string(),
            turn_id: "turn-2".to_string(),
    ...
    let expected = serde_json::from_str::<serde_json::Value>(
        r#"{
            ...
            "event_params": {
                ...
                "app_server_client": {
                    "product_client_id": "anecdoct_cli_rs",
                    "client_name": "anecdoct-tui",
                    "client_version": "1.0.0",
                    "rpc_transport": "stdio",
                    "experimental_api_enabled": true
...
async fn accepted_turn_steer_emits_expected_event() {
    ...
    assert_eq!(payload["event_type"], json!("anecdoct_turn_steer_event"));
    ...
    assert_eq!(
        payload["event_params"]["runtime"]["anecdoct_rs_version"],
        json!("0.1.0")
    );
    ...
    reducer
        .ingest(
            AnalyticsFact::Notification(Box::new(sample_turn_completed_notification(
                ...
                Some(anecdoct_app_server_protocol::AnecdoctErrorInfo::BadRequest),
            ))),
            &mut out,
        )
        .await;
