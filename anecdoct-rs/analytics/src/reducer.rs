...
use crate::events::AnecdoctCollabAgentToolCallEventParams;
use crate::events::AnecdoctCollabAgentToolCallEventRequest;
...
use crate::events::AnecdoctDynamicToolCallEventParams;
use crate::events::AnecdoctDynamicToolCallEventRequest;
use crate::events::AnecdoctFileChangeEventParams;
use crate::events::AnecdoctFileChangeEventRequest;
use crate::events::AnecdoctHookRunEventRequest;
use crate::events::AnecdoctImageGenerationEventParams;
use crate::events::AnecdoctImageGenerationEventRequest;
use crate::events::AnecdoctMcpToolCallEventParams;
use crate::events::AnecdoctMcpToolCallEventRequest;
...
use crate::events::AnecdoctTurnEventParams;
use crate::events::AnecdoctTurnEventRequest;
use crate::events::AnecdoctTurnSteerEventParams;
use crate::events::AnecdoctTurnSteerEventRequest;
use crate::events::AnecdoctWebSearchEventParams;
use crate::events::AnecdoctWebSearchEventRequest;
...
use crate::events::anecdoct_compaction_event_params;
...
use anecdoct_app_server_protocol::ClientResponse;
use anecdoct_app_server_protocol::CollabAgentStatus;
...
use anecdoct_app_server_protocol::DynamicToolCallOutputContentItem;
...
use anecdoct_app_server_protocol::NetworkPolicyRuleAction;
use anecdoct_app_server_protocol::PatchApplyStatus;
use anecdoct_app_server_protocol::PatchChangeKind;
...
use anecdoct_app_server_protocol::WebSearchAction;
use anecdoct_git_utils::collect_git_info;
...
impl<'a> AnalyticsDropSite<'a> {
    ...
    fn compaction(input: &'a AnecdoctCompactionEvent) -> Self {
        Self {
    ...
    fn tool_item(
        notification: &'a anecdoct_app_server_protocol::ItemCompletedNotification,
        item_id: &'a str,
    ) -> Self {
        Self {
...
struct CompletedTurnState {
    ...
    turn_error: Option<AnecdoctErrorInfo>,
    completed_at: u64,
...
impl AnalyticsReducer {
    ...
    fn ingest_guardian_review(
        ...
        out.push(TrackEventRequest::GuardianReview(Box::new(
            GuardianReviewEventRequest {
                event_type: "anecdoct_guardian_review",
    ...
    fn ingest_app_mentioned(&mut self, input: AppMentionedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.extend(mentions.into_iter().map(|mention| {
            let event_params = anecdoct_app_metadata(&tracking, mention);
            TrackEventRequest::AppMentioned(AnecdoctAppMentionedEventRequest {
    ...
    fn ingest_app_used(&mut self, input: AppUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        let event_params = anecdoct_app_metadata(&tracking, app);
        out.push(TrackEventRequest::AppUsed(AnecdoctAppUsedEventRequest {
    ...
    fn ingest_hook_run(&mut self, input: HookRunInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::HookRun(AnecdoctHookRunEventRequest {
            event_type: "anecdoct_hook_run",
            event_params: anecdoct_hook_run_metadata(&tracking, hook),
        }));
    }
    ...
    fn ingest_plugin_used(&mut self, input: PluginUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::PluginUsed(
            AnecdoctPluginUsedEventRequest {
                event_type: "anecdoct_plugin_used",
                event_params: anecdoct_plugin_used_metadata(&tracking, plugin),
            },
        ));
    }
    ...
    fn ingest_plugin_state_changed(
        ...
        let event = AnecdoctPluginEventRequest {
            ...
            ServerNotification::TurnCompleted(notification) => {
                ...
                turn_state.completed = Some(CompletedTurnState {
                    ...
                    turn_error: notification
                        .turn
                        .error
                        .and_then(|error| error.anecdoct_error_info),
    ...
    fn ingest_compaction(
        ...
        out.push(TrackEventRequest::Compaction(Box::new(
            AnecdoctCompactionEventRequest {
                event_type: "anecdoct_compaction_event",
                event_params: anecdoct_compaction_event_params(
                    input,
    ...
    fn ingest_guardian_review_completed(
        &mut self,
        notification: anecdoct_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification,
        out: &mut Vec<TrackEventRequest>,
    ) {
    ...
    fn emit_turn_steer_event(
        ...
        out.push(TrackEventRequest::TurnSteer(
            AnecdoctTurnSteerEventRequest {
                event_type: "anecdoct_turn_steer_event",
                event_params: AnecdoctTurnSteerEventParams {
    ...
    fn emit_review_event(
        ...
        out.push(TrackEventRequest::ReviewEvent(AnecdoctReviewEventRequest {
    ...
    async fn maybe_emit_turn_event(&mut self, turn_id: &str, out: &mut Vec<TrackEventRequest>) {
        ...
        let turn_event = TrackEventRequest::TurnEvent(Box::new(AnecdoctTurnEventRequest {
            event_type: "anecdoct_turn_event",
            event_params: anecdoct_turn_event_params(
                connection_state.app_server_client.clone(),
                connection_state.runtime.clone(),
                turn_id.to_string(),
                turn_state,
    ...
    match item {
        ThreadItem::CommandExecution {
            ...
            Some(TrackEventRequest::CommandExecution(
                AnecdoctCommandExecutionEventRequest {
        ...
        ThreadItem::FileChange {
            ...
            Some(TrackEventRequest::FileChange(
                AnecdoctFileChangeEventRequest {
                    event_type: "anecdoct_file_change_event",
                    event_params: AnecdoctFileChangeEventParams {
                        base,
        ...
        ThreadItem::McpToolCall {
            ...
            Some(TrackEventRequest::McpToolCall(
                AnecdoctMcpToolCallEventRequest {
                    event_type: "anecdoct_mcp_tool_call_event",
                    event_params: AnecdoctMcpToolCallEventParams {
                        base,
        ...
        ThreadItem::DynamicToolCall {
            ...
            Some(TrackEventRequest::DynamicToolCall(
                AnecdoctDynamicToolCallEventRequest {
                    event_type: "anecdoct_dynamic_tool_call_event",
                    event_params: AnecdoctDynamicToolCallEventParams {
                        base,
        ...
        ThreadItem::CollabAgentToolCall {
            ...
            Some(TrackEventRequest::CollabAgentToolCall(
                AnecdoctCollabAgentToolCallEventRequest {
                    event_type: "anecdoct_collab_agent_tool_call_event",
                    event_params: AnecdoctCollabAgentToolCallEventParams {
                        base,
        ...
        ThreadItem::WebSearch { id, query, action } => {
            ...
            Some(TrackEventRequest::WebSearch(
                AnecdoctWebSearchEventRequest {
                    event_type: "anecdoct_web_search_event",
                    event_params: AnecdoctWebSearchEventParams {
                        base,
        ...
        ThreadItem::ImageGeneration {
            ...
            Some(TrackEventRequest::ImageGeneration(
                AnecdoctImageGenerationEventRequest {
                    event_type: "anecdoct_image_generation_event",
                    event_params: AnecdoctImageGenerationEventParams {
                        base,
...
fn file_change_counts(
    changes: &[anecdoct_app_server_protocol::FileUpdateChange],
) -> FileChangeCounts {
...
fn anecdoct_turn_event_params(
    app_server_client: AnecdoctAppServerClientMetadata,
    runtime: AnecdoctRuntimeMetadata,
    turn_id: String,
    turn_state: &TurnState,
    thread_metadata: &ThreadMetadataState,
) -> AnecdoctTurnEventParams {
...
fn analytics_turn_status(status: anecdoct_app_server_protocol::TurnStatus) -> Option<TurnStatus> {
    match status {
        anecdoct_app_server_protocol::TurnStatus::Completed => Some(TurnStatus::Completed),
        anecdoct_app_server_protocol::TurnStatus::Failed => Some(TurnStatus::Failed),
        anecdoct_app_server_protocol::TurnStatus::Interrupted => Some(TurnStatus::Interrupted),
        anecdoct_app_server_protocol::TurnStatus::InProgress => None,
    }
}
