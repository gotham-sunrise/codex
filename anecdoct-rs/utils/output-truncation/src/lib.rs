//! Helpers for truncating tool and exec output using [`TruncationPolicy`](anecdoct_protocol::protocol::TruncationPolicy).

use anecdoct_protocol::models::FunctionCallOutputContentItem;
pub use anecdoct_utils_string::approx_bytes_for_tokens;
pub use anecdoct_utils_string::approx_token_count;
pub use anecdoct_utils_string::approx_tokens_from_byte_count;
use anecdoct_utils_string::truncate_middle_chars;
use anecdoct_utils_string::truncate_middle_with_token_budget;

pub use anecdoct_protocol::protocol::TruncationPolicy;
