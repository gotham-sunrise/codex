# anecdoct-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Anecdoct did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Anecdoct on it. Feel free to update the documentation as you
modify the code
...
```rust
use anecdoct_utils_stream_parser::CitationStreamParser;
use anecdoct_utils_stream_parser::StreamTextParser;
...
```rust
use anecdoct_utils_stream_parser::CitationStreamParser;
use anecdoct_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), anecdoct_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use anecdoct_utils_stream_parser::InlineHiddenTagParser;
use anecdoct_utils_stream_parser::InlineTagSpec;
use anecdoct_utils_stream_parser::StreamTextParser;
