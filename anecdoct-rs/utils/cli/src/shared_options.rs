//! Shared command-line flags used by both interactive and non-interactive Anecdoct entry points.

use crate::SandboxModeCliArg;
use anecdoct_protocol::config_types::ProfileV2Name;
use clap::Args;
...
pub struct SharedCliOptions {
    ...
    /// Layer $ANECDOCT_HOME/<name>.config.toml on top of the base user config.
    #[arg(long = "profile-v2")]
