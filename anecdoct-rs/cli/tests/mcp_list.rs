...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = anecdoct_command(anecdoct_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(anecdoct_home.path()).await?;
    ...
    let mut list_cmd = anecdoct_command(anecdoct_home.path())?;
    ...
    let mut list_json_cmd = anecdoct_command(anecdoct_home.path())?;
    ...
    let mut get_cmd = anecdoct_command(anecdoct_home.path())?;
    ...
    assert!(stdout.contains("remove: anecdoct mcp remove docs"));

    let mut get_json_cmd = anecdoct_command(anecdoct_home.path())?;
    get_json_cmd
