//! Diagnoses whether Anecdoct update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/lambogenius/anecdoct/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/anecdoct.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.anecdoct_home.join(VERSION_FILE_NAME);
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match context {
        ...
        InstallContext::Brew => "brew upgrade --cask anecdoct",
