...
pub use anecdoct_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\anecdoct.zip").as_deref(),
            Some("/mnt/c/Temp/anecdoct.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/anecdoct.tgz").as_deref(),
            Some("/mnt/d/Work/anecdoct.tgz")
        );
        assert!(win_path_to_wsl("/home/user/anecdoct").is_none());
    }
