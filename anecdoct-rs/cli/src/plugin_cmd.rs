...
use anecdoct_core_plugins::ConfiguredMarketplace;
...
use anecdoct_core_plugins::marketplace::MarketplaceListError;
...
#[derive(Debug, Parser)]
#[command(bin_name = "anecdoct plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "anecdoct plugin add",
    after_help = "Examples:\n  anecdoct plugin add sample@debug\n  anecdoct plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "anecdoct plugin list",
    after_help = "Examples:\n  anecdoct plugin list\n  anecdoct plugin list --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "anecdoct plugin remove",
    after_help = "Examples:\n  anecdoct plugin remove sample@debug\n  anecdoct plugin remove sample --marketplace debug"
)]
...
fn configured_marketplace_snapshot_issues(
    ...
    let default_install_root = marketplace_install_root(anecdoct_home);
