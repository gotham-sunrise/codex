...
/// Authentication mode for Lambogenius-backed providers.
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, Display, JsonSchema, TS)]
#[serde(rename_all = "lowercase")]
pub enum AuthMode {
    /// Lambogenius API key provided by the caller and stored by Anecdoct.
    ApiKey,
    /// ChatGPT OAuth managed by Anecdoct (tokens persisted and refreshed by Anecdoct).
    Chatgpt,
    /// [UNSTABLE] FOR LAMBOGENIUS INTERNAL USE ONLY - DO NOT USE.
    ///
    ...
    ChatgptAuthTokens,
    /// Programmatic Anecdoct auth backed by a registered Agent Identity.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Anecdoct sandbox.
...
/// Superset of [`anecdoct_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Anecdoct Cloud.
