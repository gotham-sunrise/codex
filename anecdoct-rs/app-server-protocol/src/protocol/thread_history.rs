...
use anecdoct_protocol::protocol::AgentReasoningEvent;
use anecdoct_protocol::protocol::AgentReasoningRawContentEvent;
...
use anecdoct_protocol::protocol::ContextCompactedEvent;
use anecdoct_protocol::protocol::DynamicToolCallResponseEvent;
use anecdoct_protocol::protocol::ErrorEvent;
use anecdoct_protocol::protocol::EventMsg;
use anecdoct_protocol::protocol::ExecCommandBeginEvent;
use anecdoct_protocol::protocol::ExecCommandEndEvent;
use anecdoct_protocol::protocol::GuardianAssessmentEvent;
use anecdoct_protocol::protocol::GuardianAssessmentStatus;
use anecdoct_protocol::protocol::ImageGenerationBeginEvent;
use anecdoct_protocol::protocol::ImageGenerationEndEvent;
use anecdoct_protocol::protocol::ItemCompletedEvent;
use anecdoct_protocol::protocol::ItemStartedEvent;
use anecdoct_protocol::protocol::McpToolCallBeginEvent;
use anecdoct_protocol::protocol::McpToolCallEndEvent;
use anecdoct_protocol::protocol::PatchApplyBeginEvent;
use anecdoct_protocol::protocol::PatchApplyEndEvent;
...
use anecdoct_protocol::protocol::ViewImageToolCallEvent;
use anecdoct_protocol::protocol::WebSearchBeginEvent;
use anecdoct_protocol::protocol::WebSearchEndEvent;
...
#[cfg(test)]
use anecdoct_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
#[cfg(test)]
use anecdoct_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `anecdoct-rs/core/rollout/policy.rs`.
    ...
    fn handle_response_item(&mut self, item: &anecdoct_protocol::models::ResponseItem) {
    ...
    fn handle_item_started(&mut self, payload: &ItemStartedEvent) {
        match &payload.item {
            anecdoct_protocol::items::TurnItem::Plan(plan) => {
            ...
            anecdoct_protocol::items::TurnItem::UserMessage(_)
            | anecdoct_protocol::items::TurnItem::HookPrompt(_)
            | anecdoct_protocol::items::TurnItem::AgentMessage(_)
            | anecdoct_protocol::items::TurnItem::Reasoning(_)
            | anecdoct_protocol::items::TurnItem::WebSearch(_)
            | anecdoct_protocol::items::TurnItem::ImageView(_)
            | anecdoct_protocol::items::TurnItem::ImageGeneration(_)
            | anecdoct_protocol::items::TurnItem::FileChange(_)
            | anecdoct_protocol::items::TurnItem::McpToolCall(_)
            | anecdoct_protocol::items::TurnItem::ContextCompaction(_) => {}
        }
    }
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &anecdoct_protocol::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_close_end(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabCloseEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &anecdoct_protocol::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(&mut self, payload: &anecdoct_protocol::protocol::ReviewRequest) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &anecdoct_protocol::protocol::ExitedReviewModeEvent,
    ) {
        let review = payload
            .review_output
            .as_ref()
    ...
    fn handle_error(&mut self, payload: &ErrorEvent) {
        ...
        turn.error = Some(V2TurnError {
            ...
            anecdoct_error_info: payload.anecdoct_error_info.clone().map(Into::into),
...
fn convert_dynamic_tool_content_items(
    items: &[anecdoct_protocol::dynamic_tools::DynamicToolCallOutputContentItem],
) -> Vec<DynamicToolCallOutputContentItem> {
    items
        .iter()
        .cloned()
        .map(|item| match item {
            anecdoct_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputText {
                text,
            } => DynamicToolCallOutputContentItem::InputText { text },
            anecdoct_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputImage {
                image_url,
...
mod tests {
    ...
    use anecdoct_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use anecdoct_protocol::items::HookPromptFragment as CoreHookPromptFragment;
    use anecdoct_protocol::items::TurnItem as CoreTurnItem;
    use anecdoct_protocol::items::UserMessageItem as CoreUserMessageItem;
    ...
    use anecdoct_protocol::models::MessagePhase as CoreMessagePhase;
    use anecdoct_protocol::models::WebSearchAction as CoreWebSearchAction;
    use anecdoct_protocol::parse_command::ParsedCommand;
    ...
    use anecdoct_protocol::protocol::DynamicToolCallResponseEvent;
    use anecdoct_protocol::protocol::ExecCommandEndEvent;
    use anecdoct_protocol::protocol::ExecCommandSource;
    use anecdoct_protocol::protocol::ItemStartedEvent;
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                anecdoct_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
                    namespace: Some("anecdoct_app".into()),
        ...
        let events = vec![
            ...
            EventMsg::PatchApplyEnd(PatchApplyEndEvent {
                ...
                changes: [(
                    ...
                    anecdoct_protocol::protocol::FileChange::Add {
                        content: "hello\n".into(),
                    },
                )]
                .into_iter()
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(anecdoct_protocol::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_collab_spawn_end_item_with_model_metadata() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(anecdoct_protocol::protocol::CollabAgentSpawnEndEvent {
                ...
                reasoning_effort: anecdoct_protocol::lambogenius_models::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(
                    anecdoct_protocol::lambogenius_models::ReasoningEffort::Medium
                ),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                anecdoct_protocol::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                anecdoct_protocol::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn rollback_failed_error_does_not_mark_turn_failed() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                anecdoct_error_info: Some(AnecdoctErrorInfo::ThreadRollbackFailed),
            }),
        ];
    ...
    fn error_then_turn_complete_preserves_failed_status() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                anecdoct_error_info: Some(AnecdoctErrorInfo::ResponseStreamDisconnected {
        ...
        assert_eq!(
            ...
            Some(TurnError {
                message: "stream failure".into(),
                anecdoct_error_info: Some(
                    crate::protocol::v2::AnecdoctErrorInfo::ResponseStreamDisconnected {
                        http_status_code: Some(502),
                    }
                ),
                additional_details: None,
    ...
    fn ignores_plain_user_response_items_in_rollout_replay() {
        let items = vec![
            ...
            RolloutItem::ResponseItem(anecdoct_protocol::models::ResponseItem::Message {
                id: Some("msg-1".into()),
                role: "user".into(),
