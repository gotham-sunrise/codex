...
use anecdoct_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use anecdoct_protocol::protocol::TokenUsage as CoreTokenUsage;
use anecdoct_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. Anecdoct Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR ANECDOCT CLOUD - DO NOT USE.
...
impl From<anecdoct_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: anecdoct_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> anecdoct_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => anecdoct_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => anecdoct_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `anecdoct_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
