...
use anecdoct_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use anecdoct_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use anecdoct_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use anecdoct_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use anecdoct_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use anecdoct_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> anecdoct_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<anecdoct_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: anecdoct_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            anecdoct_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            anecdoct_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            anecdoct_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
