...
use anecdoct_protocol::items::McpToolCallError as CoreMcpToolCallError;
use anecdoct_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use anecdoct_protocol::mcp::Resource as McpResource;
pub use anecdoct_protocol::mcp::ResourceContent as McpResourceContent;
use anecdoct_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use anecdoct_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from anecdoct_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> anecdoct_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => anecdoct_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => anecdoct_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => anecdoct_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Anecdoct turn when this elicitation was observed, if app-server could correlate one.
    ///
