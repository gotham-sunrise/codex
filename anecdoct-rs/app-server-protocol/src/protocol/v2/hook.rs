...
use anecdoct_protocol::protocol::HookEventName as CoreHookEventName;
use anecdoct_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use anecdoct_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use anecdoct_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use anecdoct_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use anecdoct_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use anecdoct_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use anecdoct_protocol::protocol::HookScope as CoreHookScope;
use anecdoct_protocol::protocol::HookSource as CoreHookSource;
use anecdoct_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
