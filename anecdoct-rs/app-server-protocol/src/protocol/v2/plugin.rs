...
use anecdoct_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use anecdoct_protocol::protocol::SkillInterface as CoreSkillInterface;
use anecdoct_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use anecdoct_protocol::protocol::SkillScope as CoreSkillScope;
use anecdoct_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Anecdoct app-server exposes `"AVAILABLE"` in its API; the alias keeps
