...
use anecdoct_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use anecdoct_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use anecdoct_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use anecdoct_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Anecdoct-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Anecdoct attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Anecdoct attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Anecdoct was previously using.
    ///
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `anecdoct`).
