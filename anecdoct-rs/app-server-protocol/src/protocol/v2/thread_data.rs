use super::AnecdoctErrorInfo;
use super::ThreadItem;
use super::ThreadStatus;
use super::TurnStatus;
use anecdoct_protocol::protocol::SessionSource as CoreSessionSource;
use anecdoct_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use anecdoct_protocol::protocol::ThreadSource as CoreThreadSource;
...
pub struct Thread {
    ...
    pub ephemeral: bool,
    /// Model provider used for this thread (for example, 'lambogenius').
    ...
    /// Origin of the thread (CLI, VSCode, anecdoct exec, anecdoct app-server, etc.).
