...
use anecdoct_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use anecdoct_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use anecdoct_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use anecdoct_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use anecdoct_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use anecdoct_protocol::protocol::AgentStatus as CoreAgentStatus;
use anecdoct_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use anecdoct_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use anecdoct_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use anecdoct_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use anecdoct_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use anecdoct_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
impl From<anecdoct_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: anecdoct_protocol::models::WebSearchAction) -> Self {
        match value {
            anecdoct_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            anecdoct_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            anecdoct_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            anecdoct_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<anecdoct_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: anecdoct_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for anecdoct_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
