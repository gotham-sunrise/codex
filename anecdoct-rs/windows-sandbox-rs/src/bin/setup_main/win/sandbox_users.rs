...
use anecdoct_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "AnecdoctSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Anecdoct sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(anecdoct_home);
    ...
    let secrets_dir = sandbox_secrets_dir(anecdoct_home);
