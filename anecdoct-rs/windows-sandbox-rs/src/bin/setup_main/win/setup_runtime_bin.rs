...
pub(super) fn ensure_anecdoct_app_runtime_bin_readable(
    ...
    // Anecdoct desktop copies bundled Windows binaries out of WindowsApps to this
    // fixed LocalAppData cache before launching anecdoct.exe.
