...
use anecdoct_windows_sandbox::ErrorPayload;
use anecdoct_windows_sandbox::ExitPayload;
use anecdoct_windows_sandbox::FramedMessage;
use anecdoct_windows_sandbox::LocalSid;
use anecdoct_windows_sandbox::Message;
use anecdoct_windows_sandbox::OutputPayload;
use anecdoct_windows_sandbox::OutputStream;
use anecdoct_windows_sandbox::PipeSpawnHandles;
use anecdoct_windows_sandbox::ResizePayload;
use anecdoct_windows_sandbox::SandboxPolicy;
use anecdoct_windows_sandbox::SpawnReady;
use anecdoct_windows_sandbox::SpawnRequest;
use anecdoct_windows_sandbox::StderrMode;
use anecdoct_windows_sandbox::StdinMode;
use anecdoct_windows_sandbox::allow_null_device;
use anecdoct_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use anecdoct_windows_sandbox::create_workspace_write_token_with_caps_and_user_from;
use anecdoct_windows_sandbox::decode_bytes;
use anecdoct_windows_sandbox::encode_bytes;
use anecdoct_windows_sandbox::get_current_token_for_restriction;
use anecdoct_windows_sandbox::hide_current_user_profile_dir;
use anecdoct_windows_sandbox::log_note;
use anecdoct_windows_sandbox::parse_policy;
use anecdoct_windows_sandbox::read_frame;
use anecdoct_windows_sandbox::read_handle_loop;
use anecdoct_windows_sandbox::spawn_process_with_pipes;
use anecdoct_windows_sandbox::to_wide;
use anecdoct_windows_sandbox::write_frame;
use anyhow::Context;
use anyhow::Result;
use std::ffi::OsStr;
use std::fs::File;
...
const READ_ACL_MUTEX_NAME: &str = "Local\\AnecdoctSandboxReadAcl";
...
struct IpcSpawnedProcess {
    ...
    conpty_owner: Option<anecdoct_windows_sandbox::ConptyInstance>,
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    let log_dir = req.anecdoct_home.clone();
    hide_current_user_profile_dir(req.anecdoct_home.as_path());
    ...
    let (pi, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, mut conpty) = anecdoct_windows_sandbox::spawn_conpty_process_as_user(
            h_token.raw(),
            &req.command,
            &effective_cwd,
            &req.env,
