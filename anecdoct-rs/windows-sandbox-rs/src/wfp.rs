...
const SESSION_NAME: &str = "Anecdoct Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Anecdoct Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Anecdoct Windows sandbox filters";
const SUBLAYER_NAME: &str = "Anecdoct Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Anecdoct Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Anecdoct-owned identities; do not regenerate them unless we
...
/// Installs the persistent Anecdoct WFP filters for `account`.
///
...
/// Ensures the persistent Anecdoct WFP provider exists.
...
/// Ensures the persistent Anecdoct sublayer exists under the Anecdoct provider.
