...
mod windows_impl {
    ...
    pub fn run_windows_sandbox_capture(
        ...
        ensure_anecdoct_home_exists(&sandbox_base)?;
        ...
        let (sid_for_null, cap_sids) = match &policy {
            ...
            SandboxPolicy::WorkspaceWrite { .. } => {
                ...
                let cap_sids = write_roots
                    .iter()
                    .map(|root| workspace_write_cap_sid_for_root(anecdoct_home, cwd, root))
        ...
        (|| -> Result<CaptureResult> {
            let spawn_request = SpawnRequest {
                ...
                anecdoct_home: sandbox_base.clone(),
                real_anecdoct_home: anecdoct_home.to_path_buf(),
                cap_sids,
                timeout_ms,
                tty: false,
                stdin_open: false,
