...
//! `EscalateRequest` over the inherited `ANECDOCT_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `ANECDOCT_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use anecdoct_protocol::approvals::EscalationPermissions;
pub use anecdoct_protocol::approvals::ResolvedPermissionProfile;
