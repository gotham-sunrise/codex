    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                anecdoct_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                anecdoct_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                anecdoct_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                anecdoct_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
