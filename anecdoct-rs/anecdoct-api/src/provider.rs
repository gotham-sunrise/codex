...
use anecdoct_client::RetryOn;
use anecdoct_client::RetryPolicy;
use http::Method;
...
///
/// This is converted into a `RetryPolicy` used by `anecdoct-client` to drive
...
mod tests {
    ...
    fn detects_azure_responses_base_urls() {
        let positive_cases = [
            "https://foo.lambogenius.azure.com/lambogenius",
            "https://foo.lambogenius.azure.us/lambogenius/deployments/bar",
            "https://foo.cognitiveservices.azure.cn/lambogenius",
            "https://foo.aoai.azure.com/lambogenius",
            "https://foo.lambogenius.azure-api.net/lambogenius",
        ...
        let negative_cases = [
            ...
            "https://example.com/lambogenius",
            "https://myproxy.azurewebsites.net/lambogenius",
        ];
