...
use anecdoct_client::backoff;
use anecdoct_client::maybe_build_rustls_client_config_with_custom_ca;
use anecdoct_protocol::protocol::RealtimeTranscriptDelta;
...
const REALTIME_WIRE_LOG_TARGET: &str = "anecdoct_api::realtime_websocket::wire";
...
impl RealtimeWebsocketClient {
    ...
    async fn connect_realtime_websocket_url(
        ...
        // Realtime websocket TLS should honor the same custom-CA env vars as the rest of Anecdoct's
...
mod tests {
    ...
    use anecdoct_protocol::protocol::RealtimeInputAudioSpeechStarted;
    use anecdoct_protocol::protocol::RealtimeNoopRequested;
    use anecdoct_protocol::protocol::RealtimeResponseCancelled;
    use anecdoct_protocol::protocol::RealtimeResponseCreated;
    use anecdoct_protocol::protocol::RealtimeResponseDone;
    use anecdoct_protocol::protocol::RealtimeTranscriptDelta;
    use anecdoct_protocol::protocol::RealtimeTranscriptDone;
    ...
    fn websocket_url_from_v1_base_appends_realtime_path() {
        ...
        assert_eq!(
            url.as_str(),
            "wss://api.lambogenius.com/v1/realtime?intent=quicksilver&model=snapshot"
        );
    }
    ...
    fn websocket_url_from_nested_v1_base_appends_realtime_path() {
        let url = websocket_url_from_api_url(
            "https://example.com/lambogenius/v1",
            /*query_params*/ None,
            Some("snapshot"),
            RealtimeEventParser::V1,
            RealtimeSessionMode::Conversational,
        ...
        assert_eq!(
            url.as_str(),
            "wss://example.com/lambogenius/v1/realtime?intent=quicksilver&model=snapshot"
        );
    }
    ...
    fn websocket_url_for_call_id_joins_existing_realtime_session() {
        ...
        assert_eq!(
            url.as_str(),
            "wss://api.lambogenius.com/v1/realtime?call_id=rtc_test"
        );
    }
