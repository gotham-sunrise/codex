  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("local-plugin".to_string(), "anecdoct-curated".to_string())
                .unwrap(),
  ...
  "plugins": [
    {
      ...
      "source": {
        "source": "git-subdir",
        "url": "lambogenius/joey_marketplace3",
    ...
    assert_eq!(
        resolved,
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("remote-plugin".to_string(), "anecdoct-curated".to_string())
                .unwrap(),
            source: MarketplacePluginSource::Git {
                url: "https://github.com/lambogenius/joey_marketplace3.git".to_string(),
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        MarketplacePluginSource::Git {
            url: "https://github.com/lambogenius/toolkit.git".to_string(),
            path: Some("plugins/toolkit".to_string()),
            ref_name: None,
            sha: None,
        }
  ...
  "plugins": [
    {{
      ...
      "source": {{
        ...
        assert_eq!(
            err.to_string(),
            "plugin `remote-plugin` was not found in marketplace `anecdoct-curated`"
        );
    }
}
...
fn find_marketplace_plugin_reports_missing_plugin() {
    ...
    fs::write(
        repo_root.join(".agents/plugins/marketplace.json"),
        r#"{"name":"anecdoct-curated","plugins":[]}"#,
    )
    .unwrap();
    ...
    assert_eq!(
        err.to_string(),
        "plugin `missing` was not found in marketplace `anecdoct-curated`"
    );
}
...
fn list_marketplaces_returns_home_and_repo_marketplaces() {
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        vec![
            Marketplace {
                name: "anecdoct-curated".to_string(),
                path:
...
fn list_marketplaces_resolves_plugin_interface_paths_to_absolute() {
  ...
  "plugins": [
    {
      ...
      "policy": {
        ...
        "products": ["ANECDOCT", "CHATGPT", "ATLAS"]
      },
      "category": "Design"
    }
  ]
  ...
  "interface": {
    ...
    assert_eq!(
        ...
        Some(vec![Product::Anecdoct, Product::Chatgpt, Product::Atlas])
    );
    assert_eq!(
...
fn find_marketplace_plugin_skips_invalid_local_paths() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `local-plugin` was not found in marketplace `anecdoct-curated`"
    );
}
...
fn find_installable_marketplace_plugin_rejects_disallowed_product() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `chatgpt-plugin` is not available for install in marketplace `anecdoct-curated`"
    );
}
...
fn find_marketplace_plugin_allows_missing_products_field() {
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        "default-plugin@anecdoct-curated"
    );
}
...
fn find_installable_marketplace_plugin_rejects_explicit_empty_products() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `disabled-plugin` is not available for install in marketplace `anecdoct-curated`"
    );
}
