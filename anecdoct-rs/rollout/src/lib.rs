//! Rollout persistence and discovery for Anecdoct session files.
...
pub(crate) mod default_client {
    pub use anecdoct_login::default_client::*;
}

pub(crate) use anecdoct_protocol::protocol;
...
pub use anecdoct_protocol::protocol::SessionMeta;
