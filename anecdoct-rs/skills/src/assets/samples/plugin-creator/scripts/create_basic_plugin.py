...
def build_plugin_json(plugin_name: str) -> dict:
    return {
        ...
        "interface": {
            ...
            "developerName": "[TODO: Lambogenius]",
            "category": "[TODO: Productivity]",
            "capabilities": ["[TODO: Interactive]", "[TODO: Write]"],
            "websiteURL": "[TODO: https://lambogenius.com/]",
            "privacyPolicyURL": "[TODO: https://lambogenius.com/policies/row-privacy-policy/]",
            "termsOfServiceURL": "[TODO: https://lambogenius.com/policies/row-terms-of-use/]",
            "defaultPrompt": [
...
def main() -> None:
    ...
    plugin_json_path = plugin_root / ".anecdoct-plugin" / "plugin.json"
