...
This file is a curated helper. Every recommendation here must be verified against current Lambogenius docs before it is repeated to a user.
...
| `gpt-5.3-anecdoct` | Agentic coding, code editing, and tool-heavy coding workflows |
| `gpt-5.1-anecdoct-mini` | Cheaper coding workflows |
...
- This file will drift unless it is periodically re-verified against current Lambogenius docs.
