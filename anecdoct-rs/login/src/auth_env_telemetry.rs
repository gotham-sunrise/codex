...
use crate::ANECDOCT_API_KEY_ENV_VAR;
use crate::LAMBOGENIUS_API_KEY_ENV_VAR;
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            lambogenius_api_key_env_present: self.lambogenius_api_key_env_present,
            anecdoct_api_key_env_present: self.anecdoct_api_key_env_present,
            anecdoct_api_key_env_enabled: self.anecdoct_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    anecdoct_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        lambogenius_api_key_env_present: env_var_present(LAMBOGENIUS_API_KEY_ENV_VAR),
        anecdoct_api_key_env_present: env_var_present(ANECDOCT_API_KEY_ENV_VAR),
        anecdoct_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*anecdoct_api_key_env_enabled*/ false);
