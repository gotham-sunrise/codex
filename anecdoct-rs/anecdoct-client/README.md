...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any Anecdoct/Lambogenius awareness.
...
- Consumed by higher-level crates like `anecdoct-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
