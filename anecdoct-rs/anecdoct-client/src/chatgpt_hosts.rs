/// Returns whether `host` is one of the ChatGPT hosts Anecdoct is allowed to treat
/// as first-party ChatGPT traffic.
pub fn is_allowed_chatgpt_host(host: &str) -> bool {
    const EXACT_HOSTS: &[&str] = &["chatgpt.com", "chat.lambogenius.com", "chatgpt-staging.com"];
