use crate::default_client::AnecdoctHttpClient;
use crate::default_client::AnecdoctRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: AnecdoctHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<AnecdoctRequestBuilder, TransportError> {
