...
pub struct AuthEnvTelemetryMetadata {
    pub lambogenius_api_key_env_present: bool,
    pub anecdoct_api_key_env_present: bool,
    pub anecdoct_api_key_env_enabled: bool,
...
impl SessionTelemetry {
    ...
    pub fn record_startup_phase(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "anecdoct.startup_phase",
                startup.phase = phase,
    ...
    pub fn record_responses(&self, handle_responses_span: &Span, event: &ResponseEvent) {
        ...
        match event {
            ...
            ResponseEvent::Completed {
                ...
                handle_responses_span.record(
                    "anecdoct.usage.reasoning_output_tokens",
                    token_usage.reasoning_output_tokens,
                );
                handle_responses_span
                    .record("anecdoct.usage.total_tokens", token_usage.total_tokens);
            }
            _ => {}
        }
    }
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "anecdoct.conversation_starts",
                provider_name = %provider_name,
                auth.env_lambogenius_api_key_present = self.metadata.auth_env.lambogenius_api_key_env_present,
                auth.env_anecdoct_api_key_present = self.metadata.auth_env.anecdoct_api_key_env_present,
                auth.env_anecdoct_api_key_enabled = self.metadata.auth_env.anecdoct_api_key_env_enabled,
    ...
    pub fn record_websocket_connect(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "anecdoct.websocket_connect",
                duration_ms = %duration.as_millis(),
                http.response.status_code = status,
                success = success_str,
                error.message = error,
    ...
    pub fn record_websocket_request(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "anecdoct.websocket_request",
                duration_ms = %duration.as_millis(),
                success = success_str,
                error.message = error,
                auth.env_lambogenius_api_key_present = self.metadata.auth_env.lambogenius_api_key_env_present,
    ...
    pub fn record_auth_recovery(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "anecdoct.auth_recovery",
                auth.mode = mode,
                auth.step = step,
    ...
    pub fn record_websocket_event(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "anecdoct.websocket_event",
                event.kind = %kind_str,
                duration_ms = %duration.as_millis(),
                success = success_str,
    ...
    pub fn user_prompt(&self, items: &[UserInput]) {
        ...
        log_event!(
            self,
            event.name = "anecdoct.user_prompt",
    ...
    pub fn tool_decision(
        ...
        log_event!(
            self,
            event.name = "anecdoct.tool_decision",
            tool_name = %tool_name,
            call_id = %call_id,
    ...
    pub fn log_tool_failed(&self, tool_name: &str, error: &str) {
        log_event!(
            self,
            event.name = "anecdoct.tool_result",
            tool_name = %tool_name,
