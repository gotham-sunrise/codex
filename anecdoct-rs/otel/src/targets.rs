pub(crate) const OTEL_TARGET_PREFIX: &str = "anecdoct_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "anecdoct_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "anecdoct_otel.trace_safe";
