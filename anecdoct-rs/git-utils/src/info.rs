...
/// directory. If you need Anecdoct to work from such a checkout simply pass the
...
mod tests {
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:Lambogenius/Anecdoct.git",
            "ssh://git@github.com/lambogenius/anecdoct.git",
            "ssh://git@github.com:22/Lambogenius/Anecdoct.git",
            "https://github.com/lambogenius/anecdoct.git",
            "https://github.com:443/lambogenius/anecdoct.git",
            "https://token@github.com/lambogenius/anecdoct/",
            "github.com/Lambogenius/Anecdoct.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/lambogenius/anecdoct".to_string())
            );
        }
    }
