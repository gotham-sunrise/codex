...
def sample_pr():
    return {
        "number": 123,
        "url": "https://github.com/lambogenius/anecdoct/pull/123",
        "repo": "lambogenius/anecdoct",
        "head_sha": "abc123",
        "head_branch": "feature",
        "state": "OPEN",
        "merged": False,
...
def test_run_watch_keeps_polling_open_ready_to_merge_pr(monkeypatch):
    ...
    monkeypatch.setattr(
        gh_pr_watch,
        "collect_snapshot",
        lambda args: (snapshot, Path("/tmp/anecdoct-babysit-pr-state.json")),
    )
    monkeypatch.setattr(
        gh_pr_watch,
        "print_event",
        ...
        99: [
            {
                ...
                "status": "completed",
                "conclusion": "failure",
                "html_url": "https://github.com/lambogenius/anecdoct/actions/runs/99/job/555",
            },
            {
                "id": 556,
                "name": "lint",
    ...
    assert failed_jobs == [
        {
            ...
            "conclusion": "failure",
            "html_url": "https://github.com/lambogenius/anecdoct/actions/runs/99/job/555",
            "logs_endpoint": "repos/lambogenius/anecdoct/actions/jobs/555/logs",
        }
    ]
