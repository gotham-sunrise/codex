---
name: test-tui
description: Guide for testing Anecdoct TUI interactively
---

You can start and use Anecdoct TUI to verify changes. 
...
Use `just anecdoct` target to run - `just anecdoct -c ...`
